...
#define CONTROL_ADDR_Y_DATA   0x20
#define CONTROL_BITS_Y_DATA   16
#define CONTROL_ADDR_Y_CTRL   0x24
#define CONTROL_ADDR_IDX_DATA 0x30
#define CONTROL_BITS_IDX_DATA 3
#define CONTROL_ADDR_IDX_CTRL 0x34

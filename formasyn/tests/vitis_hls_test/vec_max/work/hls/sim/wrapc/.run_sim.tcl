...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vec_max.autotvin.dat"
	set constFileTvOut       "vec_max.autotvout.dat"
	set constFileHdlTvIn     "vec_max.autohdltvin.dat"
	set constFileHdlTvOut    "vec_max.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

...
`ifndef VEC_MAX_SUBSYSTEM_MONITOR_SV
`define VEC_MAX_SUBSYSTEM_MONITOR_SV

`uvm_analysis_imp_decl(_axi_wtr_control)
`uvm_analysis_imp_decl(_axi_rtr_control)

class vec_max_subsystem_monitor extends uvm_component;

    vec_max_reference_model refm;
    vec_max_scoreboard scbd;

    `uvm_component_utils_begin(vec_max_subsystem_monitor)
    `uvm_component_utils_end

    uvm_analysis_imp_axi_wtr_control#(axi_pkg::axi_transfer, vec_max_subsystem_monitor) control_wtr_imp;
    uvm_analysis_imp_axi_rtr_control#(axi_pkg::axi_transfer, vec_max_subsystem_monitor) control_rtr_imp;
    ...
    virtual function void build_phase(uvm_phase phase);
        ...
        scbd = vec_max_scoreboard::type_id::create("scbd", this);
    endfunction

...
`ifndef VEC_MAX_REFERENCE_MODEL_SV
`define VEC_MAX_REFERENCE_MODEL_SV

class vec_max_reference_model extends uvm_component;
`define TV_IN_a "../tv/cdatafile/c.vec_max.autotvin_a.dat"
`define TV_OUT_a ""
`define TV_IN_y ""
`define TV_OUT_y "../tv/rtldatafile/rtl.vec_max.autotvout_y.dat"
`define TV_IN_idx ""
`define TV_OUT_idx "../tv/rtldatafile/rtl.vec_max.autotvout_idx.dat"
    ...
    mem_model_pages#(3,8) mem_blk_pages_control_idx;
    
    `uvm_component_utils_begin(vec_max_reference_model)
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_control_y.init_pages(trans_num_total, 1*((16+7)/8), 32);
        mem_blk_pages_control_y.tvoutdump_atinit(`TV_OUT_y);


        mem_blk_pages_control_idx = mem_model_pages#(3,8)::type_id::create("mem_blk_pages_control_idx");
        mem_blk_pages_control_idx.init_pages(trans_num_total, 1*((4+7)/8), 48);
        mem_blk_pages_control_idx.tvoutdump_atinit(`TV_OUT_idx);
    ...
    virtual function void write_axi_rtr_control(axi_pkg::axi_transfer tr);
        ...
        if(tr.addr == 0 && tr.len == 0) begin
            ...
            mem_blk_pages_control_idx.write_elems_frontpage(tr.data, tr.byte_addr);
        end
    endfunction
endclass
`endif

; ModuleID = '/home/chengzhy/FormaSyn/formasyn/tests/vitis_hls_test/scaler/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_kernel_ir(%"struct.ap_int<16>"* nocapture readonly %x_in, %"struct.ap_int<16>"* nocapture readonly %gain, %"struct.ap_int<16>"* noalias nocapture nonnull dereferenceable(2) %y_out) local_unnamed_addr #0 {
entry:
  %y_out_copy = alloca i16, align 512
  call fastcc void @copy_in(%"struct.ap_int<16>"* nonnull %y_out, i16* nonnull align 512 %y_out_copy)
  call void @apatb_kernel_hw(%"struct.ap_int<16>"* %x_in, %"struct.ap_int<16>"* %gain, i16* %y_out_copy)
...
declare void @apatb_kernel_hw(%"struct.ap_int<16>"*, %"struct.ap_int<16>"*, i16*)
...
declare void @kernel_hw_stub(%"struct.ap_int<16>"* nocapture readonly, %"struct.ap_int<16>"* nocapture readonly, %"struct.ap_int<16>"* noalias nocapture nonnull)

define void @kernel_hw_stub_wrapper(%"struct.ap_int<16>"*, %"struct.ap_int<16>"*, i16*) #4 {
entry:
  %3 = call i8* @malloc(i64 2)
  %4 = bitcast i8* %3 to %"struct.ap_int<16>"*
  call void @copy_out(%"struct.ap_int<16>"* %4, i16* %2)
  call void @kernel_hw_stub(%"struct.ap_int<16>"* %0, %"struct.ap_int<16>"* %1, %"struct.ap_int<16>"* %4)
  call void @copy_in(%"struct.ap_int<16>"* %4, i16* %2)
  call void @free(i8* %3)
  ret void
}

...
#define AUTOTB_TVIN_gain "../tv/cdatafile/c.kernel.autotvin_gain.dat"
#define AUTOTB_TVOUT_gain "../tv/cdatafile/c.kernel.autotvout_gain.dat"
...
extern "C"
void kernel_hw_stub_wrapper(hls::sim::Byte<2>*, hls::sim::Byte<2>*, void*);

extern "C"
void apatb_kernel_hw(hls::sim::Byte<2>* __xlx_apatb_param_x_in, hls::sim::Byte<2>* __xlx_apatb_param_gain, void* __xlx_apatb_param_y_out)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_gain),
#endif
  };
  port1.param = __xlx_apatb_param_gain;
  ...
  port2.param = __xlx_apatb_param_y_out;
  ...
  try {
    ...
    kernel_hw_stub_wrapper(__xlx_apatb_param_x_in, __xlx_apatb_param_gain, __xlx_apatb_param_y_out);

...
`define TV_OUT_x_in ""
`define TV_IN_gain "../tv/cdatafile/c.kernel.autotvin_gain.dat"
`define TV_OUT_gain ""
`define TV_IN_y_out ""
`define TV_OUT_y_out "../tv/rtldatafile/rtl.kernel.autotvout_y_out.dat"
    ...
    mem_model_pages#(16,8) mem_blk_pages_control_gain;
...
misc_if.dut2tb_ap_done = 0;
        ...
        fpath.push_back(`TV_IN_gain);
        mem_blk_pages_control_gain = mem_model_pages#(16,8)::type_id::create("mem_blk_pages_control_gain");
        mem_blk_pages_control_gain.tvinload_pagechk_atinit(fpath, 1*((16+7)/8), 0, 24, "");
        fpath.delete;


        mem_blk_pages_control_y_out = mem_model_pages#(16,8)::type_id::create("mem_blk_pages_control_y_out");
        mem_blk_pages_control_y_out.init_pages(trans_num_total, 1*((16+7)/8), 32);

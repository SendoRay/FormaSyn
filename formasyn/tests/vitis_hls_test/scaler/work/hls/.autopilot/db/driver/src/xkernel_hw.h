...
#define XKERNEL_CONTROL_BITS_X_IN_DATA  16
#define XKERNEL_CONTROL_ADDR_GAIN_DATA  0x18
#define XKERNEL_CONTROL_BITS_GAIN_DATA  16
#define XKERNEL_CONTROL_ADDR_Y_OUT_DATA 0x20
#define XKERNEL_CONTROL_BITS_Y_OUT_DATA 16

...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "kernel.autotvin.dat"
	set constFileTvOut       "kernel.autotvout.dat"
	set constFileHdlTvIn     "kernel.autohdltvin.dat"
	set constFileHdlTvOut    "kernel.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

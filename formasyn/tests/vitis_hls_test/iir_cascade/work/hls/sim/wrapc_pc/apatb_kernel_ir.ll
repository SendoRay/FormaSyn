; ModuleID = '/home/chengzhy/FormaSyn/formasyn/tests/vitis_hls_test/iir_cascade/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_int<16>.8"(%"struct.ap_int<16>"* %0, i16* align 512 %1)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_int<16>.8"(%"struct.ap_int<16>"* noalias "unpacked"="0" %dst, i16* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #2 {
entry:

...
#pragma HLS PIPELINE II=1
 ...
 const int TARGET_MAGNITUDE = 1000;
    const ap_fixed<16, 2> MU = 0.01;
    const ap_fixed<16, 4> MAX_GAIN = 8.0;
    const ap_fixed<16, 4> MIN_GAIN = 0.125;


    typedef ap_int<16> data_t;
    typedef ap_int<17> abs_t;
    typedef ap_fixed<16, 14> error_t;
    typedef ap_fixed<32, 8> gain_acc_t;
    typedef ap_fixed<16, 4> gain_t;
    typedef ap_fixed<32, 20> prod_t;

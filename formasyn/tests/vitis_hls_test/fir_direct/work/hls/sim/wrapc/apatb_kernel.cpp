...
extern "C"
void kernel_hw_stub_wrapper(hls::sim::Byte<2>*, void*);

extern "C"
void apatb_kernel_hw(hls::sim::Byte<2>* __xlx_apatb_param_x_in, void* __xlx_apatb_param_y_out)
{
  ...
  try {
    ...
    kernel_hw_stub_wrapper(__xlx_apatb_param_x_in, __xlx_apatb_param_y_out);

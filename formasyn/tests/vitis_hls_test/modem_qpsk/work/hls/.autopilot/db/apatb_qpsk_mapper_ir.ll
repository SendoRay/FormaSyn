; ModuleID = '/home/chengzhy/FormaSyn/formasyn/tests/vitis_hls_test/modem_qpsk/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_qpsk_mapper_ir(%"struct.ap_uint<2>"* nocapture readonly %bits_in, %"struct.ap_int<16>"* noalias nocapture nonnull %y_real, %"struct.ap_int<16>"* noalias nocapture nonnull %y_imag) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_qpsk_mapper_hw(%"struct.ap_uint<2>"* %bits_in, i16* %y_real_copy, i16* %y_imag_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_int<16>.11"(i16* align 512 %1, %"struct.ap_int<16>"* %0)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_int<16>.11"(i16* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_int<16>"* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
...
declare void @apatb_qpsk_mapper_hw(%"struct.ap_uint<2>"*, i16*, i16*)
...
declare void @qpsk_mapper_hw_stub(%"struct.ap_uint<2>"* nocapture readonly, %"struct.ap_int<16>"* noalias nocapture nonnull, %"struct.ap_int<16>"* noalias nocapture nonnull)

define void @qpsk_mapper_hw_stub_wrapper(%"struct.ap_uint<2>"*, i16*, i16*) #4 {
entry:
  ...
  call void @qpsk_mapper_hw_stub(%"struct.ap_uint<2>"* %0, %"struct.ap_int<16>"* %4, %"struct.ap_int<16>"* %6)

...
//
//==============================================================
`ifndef VEC_ADD_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define VEC_ADD_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class vec_add_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "vec_add_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(vec_add_subsys_test_sequence_lib)                                     
        `uvm_declare_p_sequencer(vec_add_virtual_sequencer)                                     
        ...
        virtual task body();                                                                        
            ...
            if (!uvm_config_db#(vec_add_reference_model)::get(p_sequencer,"", "refm", refm))

...
`define AUTOTB_DUT      vec_add
`define AUTOTB_DUT_INST AESL_inst_vec_add
`define AUTOTB_TOP      apatb_vec_add_top
`define AUTOTB_LAT_RESULT_FILE "vec_add.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "vec_add.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_vec_add_top

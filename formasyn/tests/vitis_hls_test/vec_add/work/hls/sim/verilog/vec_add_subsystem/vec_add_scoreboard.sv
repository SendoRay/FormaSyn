...
//
//==============================================================
`ifndef VEC_ADD_SCOREBOARD__SV                                                       
    `define VEC_ADD_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class vec_add_scoreboard extends uvm_component;                                        
                                                                                               
        vec_add_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(vec_add_scoreboard)                                     
        `uvm_field_object(refm  , UVM_DEFAULT)                                                 
        `uvm_component_utils_end                                                               
                                                                                               
        virtual function void build_phase(uvm_phase phase);                                    
            if (!uvm_config_db #(vec_add_reference_model)::get(this, "", "refm", refm))

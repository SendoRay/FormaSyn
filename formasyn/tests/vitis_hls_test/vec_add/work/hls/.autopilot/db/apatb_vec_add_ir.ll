; ModuleID = '/home/chengzhy/vitis_hls_test/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: argmemonly noinline willreturn
define void @apatb_vec_add_ir(i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %a, i32* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" %b, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="16" %c) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([16 x i32]* nonnull %0, [16 x i32]* nonnull align 512 %a_copy, [16 x i32]* nonnull %1, [16 x i32]* nonnull align 512 %b_copy, [16 x i32]* nonnull %2, [16 x i32]* nonnull align 512 %c_copy)
  call void @apatb_vec_add_hw([16 x i32]* %a_copy, [16 x i32]* %b_copy, [16 x i32]* %c_copy)
  call void @copy_back([16 x i32]* %0, [16 x i32]* %a_copy, [16 x i32]* %1, [16 x i32]* %b_copy, [16 x i32]* %2, [16 x i32]* %c_copy)
  ret void
}
...
declare void @apatb_vec_add_hw([16 x i32]*, [16 x i32]*, [16 x i32]*)
...
declare void @vec_add_hw_stub(i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull readonly, i32* noalias nocapture nonnull)

define void @vec_add_hw_stub_wrapper([16 x i32]*, [16 x i32]*, [16 x i32]*) #5 {
entry:
  ...
  call void @vec_add_hw_stub(i32* %3, i32* %4, i32* %5)

; ModuleID = '/home/chengzhy/FormaSyn/formasyn/tests/vitis_hls_test/fir_halfband/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_kernel_ir(%"struct.ap_int<16>"* nocapture readonly %x_in, %"struct.ap_int<16>"* noalias nocapture nonnull dereferenceable(2) %y_out) local_unnamed_addr #0 {
entry:
  %y_out_copy = alloca i16, align 512
  call fastcc void @copy_in(%"struct.ap_int<16>"* nonnull %y_out, i16* nonnull align 512 %y_out_copy)
  call void @apatb_kernel_hw(%"struct.ap_int<16>"* %x_in, i16* %y_out_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_int<16>.7"(%"struct.ap_int<16>"* %0, i16* align 512 %1)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_int<16>.7"(%"struct.ap_int<16>"* noalias "unpacked"="0" %dst, i16* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
...
declare void @apatb_kernel_hw(%"struct.ap_int<16>"*, i16*)
...
declare void @kernel_hw_stub(%"struct.ap_int<16>"* nocapture readonly, %"struct.ap_int<16>"* noalias nocapture nonnull)

define void @kernel_hw_stub_wrapper(%"struct.ap_int<16>"*, i16*) #4 {
entry:
  %2 = call i8* @malloc(i64 2)
  %3 = bitcast i8* %2 to %"struct.ap_int<16>"*
  call void @copy_out(%"struct.ap_int<16>"* %3, i16* %1)
  call void @kernel_hw_stub(%"struct.ap_int<16>"* %0, %"struct.ap_int<16>"* %3)

...
#define CONTROL_BITS_X_IN_DATA  32
#define CONTROL_ADDR_BITS_DATA  0x18
#define CONTROL_BITS_BITS_DATA  5
#define CONTROL_ADDR_FRAC_DATA  0x20
#define CONTROL_BITS_FRAC_DATA  5
#define CONTROL_ADDR_Y_OUT_DATA 0x28
#define CONTROL_BITS_Y_OUT_DATA 32

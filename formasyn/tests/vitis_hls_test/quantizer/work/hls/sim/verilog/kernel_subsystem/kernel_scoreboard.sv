        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                forever begin
                    ...
                    void'(refm.mem_blk_pages_control_x_in.pages.pop_front());
                    void'(refm.mem_blk_pages_control_bits.pages.pop_front());
                end
                forever begin
                    ...
                    refm.mem_blk_pages_control_y_out.tvout_dump_frontpage(1);
                end

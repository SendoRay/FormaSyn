...
`define TV_OUT_x_in ""
`define TV_IN_bits "../tv/cdatafile/c.kernel.autotvin_bits.dat"
`define TV_OUT_bits ""
`define TV_IN_y_out ""
`define TV_OUT_y_out "../tv/rtldatafile/rtl.kernel.autotvout_y_out.dat"
    ...
    mem_model_pages#(32,8) mem_blk_pages_control_x_in;
    mem_model_pages#(5,8) mem_blk_pages_control_bits;
    mem_model_pages#(32,8) mem_blk_pages_control_y_out;
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_control_x_in = mem_model_pages#(32,8)::type_id::create("mem_blk_pages_control_x_in");
        mem_blk_pages_control_x_in.tvinload_pagechk_atinit(fpath, 1*((32+7)/8), 0, 16, "");
        fpath.delete;


        fpath.push_back(`TV_IN_bits);
        mem_blk_pages_control_bits = mem_model_pages#(5,8)::type_id::create("mem_blk_pages_control_bits");
        mem_blk_pages_control_bits.tvinload_pagechk_atinit(fpath, 1*((8+7)/8), 0, 24, "");
        fpath.delete;


        mem_blk_pages_control_y_out = mem_model_pages#(32,8)::type_id::create("mem_blk_pages_control_y_out");
        mem_blk_pages_control_y_out.init_pages(trans_num_total, 1*((32+7)/8), 40);

...
`define AESL_DEPTH_x_in 1
`define AESL_DEPTH_bits 1
`define AESL_DEPTH_frac 1
`define AESL_DEPTH_y_out 1
...
`define AUTOTB_TVIN_x_in_out_wrapc  "../tv/rtldatafile/rtl.kernel.autotvin_x_in.dat"
`define AUTOTB_TVIN_bits_out_wrapc  "../tv/rtldatafile/rtl.kernel.autotvin_bits.dat"
`define AUTOTB_TVOUT_y_out  "../tv/cdatafile/c.kernel.autotvout_y_out.dat"
`define AUTOTB_TVOUT_y_out_out_wrapc  "../tv/rtldatafile/rtl.kernel.autotvout_y_out.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 5004;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 2;
parameter LENGTH_bits = 1;
parameter LENGTH_frac = 1;
parameter LENGTH_x_in = 1;
parameter LENGTH_y_out = 1;

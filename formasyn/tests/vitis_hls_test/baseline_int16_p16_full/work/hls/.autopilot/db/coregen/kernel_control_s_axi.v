...
#(parameter
    ...
    output wire [7:0]                    x_in,
    input  wire [7:0]                    y_out_scale,
...
localparam
    ...
    ADDR_IER                = 5'h08,
    ADDR_ISR                = 5'h0c,
    ADDR_X_IN_DATA_0        = 5'h10,
    ADDR_X_IN_CTRL          = 5'h14,
    ADDR_Y_OUT_SCALE_DATA_0 = 5'h18,
    ADDR_Y_OUT_SCALE_CTRL   = 5'h1c,
    WRIDLE                  = 2'd0,
    WRDATA                  = 2'd1,
    WRRESP                  = 2'd2,
    WRRESET                 = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_Y_OUT_SCALE_DATA_0: begin
                    rdata <= int_y_out_scale[7:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_X_IN_DATA_0)
            int_x_in[7:0] <= (WDATA[31:0] & wmask) | (int_x_in[7:0] & ~wmask);
    end
end

...
// wrapc file define:
#define AUTOTB_TVIN_bit_in "../tv/cdatafile/c.bpsk_mapper.autotvin_bit_in.dat"
#define AUTOTB_TVOUT_bit_in "../tv/cdatafile/c.bpsk_mapper.autotvout_bit_in.dat"
#define AUTOTB_TVIN_y_out "../tv/cdatafile/c.bpsk_mapper.autotvin_y_out.dat"
#define AUTOTB_TVOUT_y_out "../tv/cdatafile/c.bpsk_mapper.autotvout_y_out.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_y_out "../tv/rtldatafile/rtl.bpsk_mapper.autotvout_y_out.dat"
...
extern "C"
void bpsk_mapper_hw_stub_wrapper(hls::sim::Byte<1>*, void*);

extern "C"
void apatb_bpsk_mapper_hw(hls::sim::Byte<1>* __xlx_apatb_param_bit_in, void* __xlx_apatb_param_y_out)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_bit_in),
#endif
  };
  port0.param = __xlx_apatb_param_bit_in;
  ...
  port1.param = __xlx_apatb_param_y_out;
  ...
  try {
    ...
    bpsk_mapper_hw_stub_wrapper(__xlx_apatb_param_bit_in, __xlx_apatb_param_y_out);

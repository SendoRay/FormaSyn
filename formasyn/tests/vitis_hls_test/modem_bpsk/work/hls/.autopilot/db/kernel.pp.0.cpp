...
__attribute__((sdx_kernel("bpsk_mapper", 0))) void bpsk_mapper(ap_uint<1> bit_in, ap_int<16> *y_out);
# 2 "kernel.cpp" 2
...
__attribute__((sdx_kernel("bpsk_mapper", 0))) void bpsk_mapper(ap_uint<1> bit_in, ap_int<16> *y_out) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=bpsk_mapper
# 7 "kernel.cpp"

#pragma HLS INTERFACE s_axilite port=return bundle=control
#pragma HLS INTERFACE s_axilite port=bit_in

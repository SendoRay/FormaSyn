...
# 5 "./kernel.h" 2
# 19 "./kernel.h"
__attribute__((sdx_kernel("kernel", 0))) void kernel(ap_int<16> x_in, ap_int<32>& y_out);
# 2 "kernel.cpp" 2
# 1 "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/ap_int.h" 1
# 3 "kernel.cpp" 2
# 12 "kernel.cpp"
...
#pragma HLS ARRAY_PARTITION variable=shift_reg complete
 ...
 VITIS_LOOP_41_1: for (int i = TAPS - 1; i > 0; i--) {
#pragma HLS UNROLL

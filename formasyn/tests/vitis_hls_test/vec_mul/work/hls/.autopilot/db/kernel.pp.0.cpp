...
__attribute__((sdx_kernel("vec_mul", 0))) void vec_mul(data_in_t a[8], data_in_t b[8], data_out_t y[8]);
# 2 "kernel.cpp" 2

__attribute__((sdx_kernel("vec_mul", 0))) void vec_mul(data_in_t a[8], data_in_t b[8], data_out_t y[8]) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=vec_mul
# 3 "kernel.cpp"
...
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_11_1: for (int i = 0; i < 8; i++) {

...
//------------------------Local signal-------------------
    ...
    wire [2:0]                    int_y_address0;
    wire                          int_y_ce0;
    wire [3:0]                    int_y_be0;
    wire [31:0]                   int_y_d0;
    wire [2:0]                    int_y_address1;
    wire                          int_y_ce1;
    wire [31:0]                   int_y_q1;
    reg                           int_y_read;
    reg                           int_y_write;
...
assign int_y_address1 = raddr[4 : 2];
...
module vec_mul_control_s_axi_ram
#(parameter
    MEM_STYLE  = "auto",
    MEM_TYPE   = "S2P",
    BYTE_WIDTH = 8,

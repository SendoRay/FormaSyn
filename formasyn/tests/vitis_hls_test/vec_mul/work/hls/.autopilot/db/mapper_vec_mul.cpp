...
using hls::sim::Byte;
extern "C" void vec_mul(Byte<2>*, Byte<2>*, Byte<4>*);
extern "C" void apatb_vec_mul_hw(volatile void * __xlx_apatb_param_a, volatile void * __xlx_apatb_param_b, volatile void * __xlx_apatb_param_y) {
...
__xlx_y__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_y)[i]);
  ...
  // DUT call
  vec_mul(__xlx_a__tmp_vec.data(), __xlx_b__tmp_vec.data(), __xlx_y__tmp_vec.data());

...
`ifndef VEC_MUL_REFERENCE_MODEL_SV
`define VEC_MUL_REFERENCE_MODEL_SV

class vec_mul_reference_model extends uvm_component;
`define TV_IN_a "../tv/cdatafile/c.vec_mul.autotvin_a.dat"
`define TV_OUT_a ""
`define TV_IN_b "../tv/cdatafile/c.vec_mul.autotvin_b.dat"
`define TV_OUT_b ""
`define TV_IN_y ""
`define TV_OUT_y "../tv/rtldatafile/rtl.vec_mul.autotvout_y.dat"
    ...
    mem_model_pages#(32,8) mem_blk_pages_control_y;
    
    `uvm_component_utils_begin(vec_mul_reference_model)
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_control_y = mem_model_pages#(32,8)::type_id::create("mem_blk_pages_control_y");
        mem_blk_pages_control_y.set_binary(1);
        mem_blk_pages_control_y.init_pages(trans_num_total, 8*((32+7)/8), 64);

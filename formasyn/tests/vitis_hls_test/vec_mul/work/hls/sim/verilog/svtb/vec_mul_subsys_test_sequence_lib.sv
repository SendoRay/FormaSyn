...
//
//==============================================================
`ifndef VEC_MUL_SUBSYS_TEST_SEQUENCE_LIB__SV                                              
    `define VEC_MUL_SUBSYS_TEST_SEQUENCE_LIB__SV                                          
                                                                                                    
                                                                                                    
    `include "uvm_macros.svh"                                                                     
                                                                                                    
    class vec_mul_subsys_test_sequence_lib extends uvm_sequence;                                
                                                                                                    
        function new (string name = "vec_mul_subsys_test_sequence_lib");                      
            super.new(name);                                                                        
            `uvm_info(this.get_full_name(), "new is called", UVM_LOW)                             
        endfunction                                                                                 
                                                                                                    
        `uvm_object_utils(vec_mul_subsys_test_sequence_lib)                                     
        `uvm_declare_p_sequencer(vec_mul_virtual_sequencer)                                     
        ...
        virtual task body();                                                                        
            ...
            if (!uvm_config_db#(vec_mul_reference_model)::get(p_sequencer,"", "refm", refm))
                    ...
                    fork
                        ...
                        begin
                            ...
                            for(int j=0; j<1; j=j+refm.ap_done_cnt) begin
                                ...
                                @refm.dut2tb_ap_done;
                                axi_master_rd_control_seq.datamerge_inavg(databusbit, (8*32+32-1)/32, 64, 0);

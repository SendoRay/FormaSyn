...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vec_mul.autotvin.dat"
	set constFileTvOut       "vec_mul.autotvout.dat"
	set constFileHdlTvIn     "vec_mul.autohdltvin.dat"
	set constFileHdlTvOut    "vec_mul.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

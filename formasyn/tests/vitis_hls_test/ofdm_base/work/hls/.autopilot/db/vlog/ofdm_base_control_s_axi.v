...
// ==============================================================
`timescale 1ns/1ps
module ofdm_base_control_s_axi
#(parameter
    ...
    input  wire [3:0]                    in_r_address0,
    input  wire                          in_r_ce0,
    output wire [31:0]                   in_r_q0,
    input  wire [4:0]                    out_r_address0,
...
localparam
    ...
    ADDR_IER        = 8'h08,
    ADDR_ISR        = 8'h0c,
    ADDR_IN_R_BASE  = 8'h40,
    ADDR_IN_R_HIGH  = 8'h7f,
    ADDR_OUT_R_BASE = 8'h80,
    ADDR_OUT_R_HIGH = 8'hff,
    WRIDLE          = 2'd0,
    WRDATA          = 2'd1,
    WRRESP          = 2'd2,
    WRRESET         = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [3:0]                    int_in_r_address0;
    wire                          int_in_r_ce0;
    wire [31:0]                   int_in_r_q0;
    wire [3:0]                    int_in_r_address1;
    wire                          int_in_r_ce1;
...
//------------------------Memory logic-------------------
// in_r
assign int_in_r_address0  = in_r_address0;
assign int_in_r_ce0       = in_r_ce0;
assign in_r_q0            = int_in_r_q0;
assign int_in_r_address1  = ar_hs ? raddr[5:2] : waddr[5:2];
assign int_in_r_ce1       = ar_hs | (int_in_r_write & WVALID);
assign int_in_r_we1       = int_in_r_write & w_hs;
assign int_in_r_be1       = int_in_r_we1 ? WSTRB : 4'd0;
...
assign int_out_r_address1 = raddr[6 : 2];
assign int_out_r_ce1      = ar_hs;
// int_in_r_read
always @(posedge ACLK) begin
    if (ARESET)
        int_in_r_read <= 1'b0;
...
module ofdm_base_control_s_axi_ram
#(parameter
    MEM_STYLE  = "auto",
    MEM_TYPE   = "S2P",
    BYTE_WIDTH = 8,

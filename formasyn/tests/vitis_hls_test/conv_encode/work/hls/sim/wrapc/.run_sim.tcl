...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/2025.1/Vitis/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/2025.1/Vitis/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/2025.1/Vitis/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/2025.1/Vitis/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/2025.1/Vitis/tps/lnx64/gcc-8.3.0/lib:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /tools/Xilinx/2025.1/Vitis/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "conv_encode.autotvin.dat"
	set constFileTvOut       "conv_encode.autotvout.dat"
	set constFileHdlTvIn     "conv_encode.autohdltvin.dat"
	set constFileHdlTvOut    "conv_encode.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

...
if {[file isfile conv_encode.autotvin.dat]} {
	file delete -force conv_encode.autotvin.dat
}

if {[file isfile conv_encode.autotvout.dat]} {
	file delete -force conv_encode.autotvout.dat
}

...
// ==============================================================
`timescale 1ns/1ps
module conv_encode_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER             = 5'h08,
    ADDR_ISR             = 5'h0c,
    ADDR_NUM_BITS_DATA_0 = 5'h10,
    ADDR_NUM_BITS_CTRL   = 5'h14,
    WRIDLE               = 2'd0,
    WRDATA               = 2'd1,
    WRRESP               = 2'd2,
    WRRESET              = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_NUM_BITS_DATA_0: begin
                    rdata <= int_num_bits[31:0];
                end
            endcase
        end
    end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_NUM_BITS_DATA_0)
            int_num_bits[31:0] <= (WDATA[31:0] & wmask) | (int_num_bits[31:0] & ~wmask);
    end
end

...
entity vec_dot_control_s_axi is
generic (
...
end entity vec_dot_control_s_axi;
...
architecture behave of vec_dot_control_s_axi is
    ...
    constant ADDR_Y_DATA_0 : INTEGER := 16#30#;
    constant ADDR_Y_DATA_1 : INTEGER := 16#34#;
    constant ADDR_Y_CTRL   : INTEGER := 16#38#;
    ...
    signal int_y               : UNSIGNED(39 downto 0) := (others => '0');
    -- memory signals
    ...
    component vec_dot_control_s_axi_ram is
        generic (
    ...
    end component vec_dot_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_a
int_a : vec_dot_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
...
port map (
     ...
     q1         => int_a_q1);
-- int_b
int_b : vec_dot_control_s_axi_ram
generic map (
     MEM_STYLE  => "auto",
     MEM_TYPE   => "2P",
     BYTE_WIDTH => 8,
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_Y_DATA_1 =>
                        rdata_data <= RESIZE(int_y(39 downto 32), 32);
                    when ADDR_Y_CTRL =>
...
entity vec_dot_control_s_axi_ram is
    generic (
        MEM_STYLE  : STRING :="auto";
        MEM_TYPE   : STRING :="S2P";
        BYTE_WIDTH : INTEGER :=8;
...
end entity vec_dot_control_s_axi_ram;

architecture behave of vec_dot_control_s_axi_ram is

...
__attribute__((sdx_kernel("vec_dot", 0))) void vec_dot(data_in_t a[8], data_in_t b[8], data_out_t *y);
# 2 "kernel.cpp" 2

__attribute__((sdx_kernel("vec_dot", 0))) void vec_dot(data_in_t a[8], data_in_t b[8], data_out_t *y) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=vec_dot
# 3 "kernel.cpp"
...
#pragma HLS PIPELINE II=1
 ...
 data_out_t sum = 0;
    ...
    VITIS_LOOP_13_1: for (int i = 0; i < 8; i++) {

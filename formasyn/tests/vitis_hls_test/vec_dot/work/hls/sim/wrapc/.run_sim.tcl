...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vec_dot.autotvin.dat"
	set constFileTvOut       "vec_dot.autotvout.dat"
	set constFileHdlTvIn     "vec_dot.autohdltvin.dat"
	set constFileHdlTvOut    "vec_dot.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

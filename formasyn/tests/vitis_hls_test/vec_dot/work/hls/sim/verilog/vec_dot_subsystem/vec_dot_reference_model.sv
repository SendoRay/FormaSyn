...
`ifndef VEC_DOT_REFERENCE_MODEL_SV
`define VEC_DOT_REFERENCE_MODEL_SV

class vec_dot_reference_model extends uvm_component;
`define TV_IN_a "../tv/cdatafile/c.vec_dot.autotvin_a.dat"
`define TV_OUT_a ""
`define TV_IN_b "../tv/cdatafile/c.vec_dot.autotvin_b.dat"
`define TV_OUT_b ""
`define TV_IN_y ""
`define TV_OUT_y "../tv/rtldatafile/rtl.vec_dot.autotvout_y.dat"
    ...
    mem_model_pages#(40,8) mem_blk_pages_control_y;
    
    `uvm_component_utils_begin(vec_dot_reference_model)
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_control_y = mem_model_pages#(40,8)::type_id::create("mem_blk_pages_control_y");
        mem_blk_pages_control_y.init_pages(trans_num_total, 1*((64+7)/8), 48);

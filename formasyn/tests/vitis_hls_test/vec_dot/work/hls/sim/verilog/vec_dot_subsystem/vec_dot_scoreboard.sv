...
//
//==============================================================
`ifndef VEC_DOT_SCOREBOARD__SV                                                       
    `define VEC_DOT_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class vec_dot_scoreboard extends uvm_component;                                        
                                                                                               
        vec_dot_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(vec_dot_scoreboard)                                     
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                forever begin
                    ...
                    void'(refm.mem_blk_pages_control_b.pages.pop_front());
                end
                forever begin

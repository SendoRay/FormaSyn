...
//
//==============================================================
`ifndef KERNEL_SCOREBOARD__SV                                                       
    `define KERNEL_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class kernel_scoreboard extends uvm_component;                                        
                                                                                               
        kernel_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(kernel_scoreboard)                                     
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                forever begin
                    ...
                    void'(refm.mem_blk_pages_control_x_real.pages.pop_front());
                    void'(refm.mem_blk_pages_control_x_imag.pages.pop_front());
                end
                forever begin
                    ...
                    refm.mem_blk_pages_control_y_real.tvout_dump_frontpage(1);
                    refm.mem_blk_pages_control_y_imag.tvout_dump_frontpage(1);
                end

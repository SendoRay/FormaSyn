...
`define TV_IN_x_real "../tv/cdatafile/c.kernel.autotvin_x_real.dat"
`define TV_OUT_x_real ""
`define TV_IN_x_imag "../tv/cdatafile/c.kernel.autotvin_x_imag.dat"
`define TV_OUT_x_imag ""
`define TV_IN_y_real ""
`define TV_OUT_y_real "../tv/rtldatafile/rtl.kernel.autotvout_y_real.dat"
`define TV_IN_y_imag ""
`define TV_OUT_y_imag "../tv/rtldatafile/rtl.kernel.autotvout_y_imag.dat"
    ...
    mem_model_pages#(16,8) mem_blk_pages_control_x_real;
    mem_model_pages#(16,8) mem_blk_pages_control_x_imag;
    mem_model_pages#(16,8) mem_blk_pages_control_y_real;
    mem_model_pages#(16,8) mem_blk_pages_control_y_imag;
...
misc_if.dut2tb_ap_done = 0;
        ...
        fpath.push_back(`TV_IN_x_real);
        mem_blk_pages_control_x_real = mem_model_pages#(16,8)::type_id::create("mem_blk_pages_control_x_real");
        mem_blk_pages_control_x_real.tvinload_pagechk_atinit(fpath, 1*((16+7)/8), 0, 16, "");
        fpath.delete;


        fpath.push_back(`TV_IN_x_imag);
        mem_blk_pages_control_x_imag = mem_model_pages#(16,8)::type_id::create("mem_blk_pages_control_x_imag");
        mem_blk_pages_control_x_imag.tvinload_pagechk_atinit(fpath, 1*((16+7)/8), 0, 24, "");
        fpath.delete;


        mem_blk_pages_control_y_real = mem_model_pages#(16,8)::type_id::create("mem_blk_pages_control_y_real");
        mem_blk_pages_control_y_real.init_pages(trans_num_total, 1*((16+7)/8), 32);
        mem_blk_pages_control_y_real.tvoutdump_atinit(`TV_OUT_y_real);


        mem_blk_pages_control_y_imag = mem_model_pages#(16,8)::type_id::create("mem_blk_pages_control_y_imag");
        mem_blk_pages_control_y_imag.init_pages(trans_num_total, 1*((16+7)/8), 48);
        mem_blk_pages_control_y_imag.tvoutdump_atinit(`TV_OUT_y_imag);
    ...
    virtual function void write_axi_rtr_control(axi_pkg::axi_transfer tr);
        ...
        if(tr.addr == 0 && tr.len == 0) begin
            ...
            mem_blk_pages_control_y_real.write_elems_frontpage(tr.data, tr.byte_addr);
            mem_blk_pages_control_y_imag.write_elems_frontpage(tr.data, tr.byte_addr);
        end
    endfunction
endclass
`endif

...
__attribute__((sdx_kernel("qam16_mapper", 0))) void qam16_mapper(ap_uint<4> bits_in, ap_int<16> *y_real, ap_int<16> *y_imag);
# 2 "kernel.cpp" 2
...
__attribute__((sdx_kernel("qam16_mapper", 0))) void qam16_mapper(ap_uint<4> bits_in, ap_int<16> *y_real, ap_int<16> *y_imag) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=qam16_mapper
# 9 "kernel.cpp"

#pragma HLS INTERFACE s_axilite port=return bundle=control
#pragma HLS INTERFACE s_axilite port=bits_in
#pragma HLS INTERFACE s_axilite port=y_real
#pragma HLS INTERFACE s_axilite port=y_imag

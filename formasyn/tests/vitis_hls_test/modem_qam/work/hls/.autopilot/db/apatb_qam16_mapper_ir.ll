; ModuleID = '/home/chengzhy/FormaSyn/formasyn/tests/vitis_hls_test/modem_qam/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_qam16_mapper_ir(%"struct.ap_uint<4>"* nocapture readonly %bits_in, %"struct.ap_int<16>"* noalias nocapture nonnull %y_real, %"struct.ap_int<16>"* noalias nocapture nonnull %y_imag) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_qam16_mapper_hw(%"struct.ap_uint<4>"* %bits_in, i16* %y_real_copy, i16* %y_imag_copy)
...
entry:
  call fastcc void @"onebyonecpy_hls.p0struct.ap_int<16>.10"(i16* align 512 %1, %"struct.ap_int<16>"* %0)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_int<16>.10"(i16* align 512 %3, %"struct.ap_int<16>"* %2)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_int<16>.10"(i16* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_int<16>"* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
...
declare void @apatb_qam16_mapper_hw(%"struct.ap_uint<4>"*, i16*, i16*)
...
declare void @qam16_mapper_hw_stub(%"struct.ap_uint<4>"* nocapture readonly, %"struct.ap_int<16>"* noalias nocapture nonnull, %"struct.ap_int<16>"* noalias nocapture nonnull)

define void @qam16_mapper_hw_stub_wrapper(%"struct.ap_uint<4>"*, i16*, i16*) #4 {
entry:
  %3 = call i8* @malloc(i64 2)
  %4 = bitcast i8* %3 to %"struct.ap_int<16>"*
  %5 = call i8* @malloc(i64 2)
  %6 = bitcast i8* %5 to %"struct.ap_int<16>"*
  call void @copy_out(%"struct.ap_int<16>"* %4, i16* %1, %"struct.ap_int<16>"* %6, i16* %2)
  call void @qam16_mapper_hw_stub(%"struct.ap_uint<4>"* %0, %"struct.ap_int<16>"* %4, %"struct.ap_int<16>"* %6)
  call void @copy_in(%"struct.ap_int<16>"* %4, i16* %1, %"struct.ap_int<16>"* %6, i16* %2)
  call void @free(i8* %3)
  call void @free(i8* %5)
  ret void
}

...
from FormaSyn.formasyn.checker.l1_checker import L1Checker, _parse_output
...
def test_check_runs_hls_csim(monkeypatch) -> None:
    ...
    monkeypatch.setattr("FormaSyn.formasyn.checker.l1_checker.subprocess.run", fake_run)

...
#define XKERNEL_CONTROL_ADDR_A_DATA  0x10
#define XKERNEL_CONTROL_BITS_A_DATA  64
#define XKERNEL_CONTROL_ADDR_B_DATA  0x1c
#define XKERNEL_CONTROL_BITS_B_DATA  64
#define XKERNEL_CONTROL_ADDR_C_DATA  0x28
#define XKERNEL_CONTROL_BITS_C_DATA  64

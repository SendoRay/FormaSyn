...
architecture behave of kernel_control_s_axi is
    ...
    constant ADDR_B_0_DATA_0 : INTEGER := 16#28#;
    constant ADDR_B_0_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_B_0_CTRL   : INTEGER := 16#30#;
    constant ADDR_B_1_DATA_0 : INTEGER := 16#34#;
    constant ADDR_B_1_DATA_1 : INTEGER := 16#38#;
    constant ADDR_B_1_CTRL   : INTEGER := 16#3c#;
    constant ADDR_C_0_DATA_0 : INTEGER := 16#40#;
    constant ADDR_C_0_DATA_1 : INTEGER := 16#44#;
    constant ADDR_C_0_CTRL   : INTEGER := 16#48#;
    constant ADDR_C_1_DATA_0 : INTEGER := 16#4c#;
    constant ADDR_C_1_DATA_1 : INTEGER := 16#50#;
    constant ADDR_C_1_CTRL   : INTEGER := 16#54#;

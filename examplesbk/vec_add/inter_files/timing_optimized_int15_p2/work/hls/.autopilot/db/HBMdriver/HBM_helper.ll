...
define void @_kernel_Set_c([8 x i15]*, [8 x i15]*, [16 x %"struct.ap_int<15>.5"]*, i64) {
entry:
  %4 = icmp eq [16 x %"struct.ap_int<15>.5"]* %2, null
...
for.loop:                                         ; preds = %dst.addr.0.0.06.exit, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [16 x %"struct.ap_int<15>.5"], [16 x %"struct.ap_int<15>.5"]* %2, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
  %dst.addr.0.0.06_0 = getelementptr [8 x i15], [8 x i15]* %0, i64 0, i64 %5
  %dst.addr.0.0.06_1 = getelementptr [8 x i15], [8 x i15]* %1, i64 0, i64 %5
  %7 = bitcast i15* %src.addr.0.0.05 to i16*
  %8 = load i16, i16* %7
...
dst.addr.0.0.06.case.0:                           ; preds = %for.loop
  store i15 %9, i15* %dst.addr.0.0.06_0, align 2
  br label %dst.addr.0.0.06.exit

dst.addr.0.0.06.case.1:                           ; preds = %for.loop
  %10 = icmp eq i64 %6, 1
  call void @llvm.assume(i1 %10)
  store i15 %9, i15* %dst.addr.0.0.06_1, align 2
  br label %dst.addr.0.0.06.exit
...
define void @kernel_Set_c([2 x [8 x i15]*]*, [16 x %"struct.ap_int<15>.5"]*, i64) {
entry:
  %3 = getelementptr [2 x [8 x i15]*], [2 x [8 x i15]*]* %0, i64 0, i64 0
  %4 = load [8 x i15]*, [8 x i15]** %3
  %5 = getelementptr [2 x [8 x i15]*], [2 x [8 x i15]*]* %0, i64 0, i64 1
  %6 = load [8 x i15]*, [8 x i15]** %5
  call void @_kernel_Set_c([8 x i15]* %4, [8 x i15]* %6, [16 x %"struct.ap_int<15>.5"]* %1, i64 %2)
  ret void
}

define void @_kernel_Get_c([16 x %"struct.ap_int<15>.5"]*, [8 x i15]*, [8 x i15]*, i64) {
entry:
  %4 = icmp eq [16 x %"struct.ap_int<15>.5"]* %0, null
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %src.addr.0.0.05.exit, %for.loop.lr.ph
  ...
  %5 = udiv i64 %for.loop.idx2, 2
  %6 = urem i64 %for.loop.idx2, 2
  %src.addr.0.0.05_0 = getelementptr [8 x i15], [8 x i15]* %1, i64 0, i64 %5
  %src.addr.0.0.05_1 = getelementptr [8 x i15], [8 x i15]* %2, i64 0, i64 %5
...
src.addr.0.0.05.case.0:                           ; preds = %for.loop
  %7 = bitcast i15* %src.addr.0.0.05_0 to i16*
  %8 = load i16, i16* %7
  %9 = trunc i16 %8 to i15
...
src.addr.0.0.05.case.1:                           ; preds = %for.loop
  %10 = icmp eq i64 %6, 1
  call void @llvm.assume(i1 %10)
  %11 = bitcast i15* %src.addr.0.0.05_1 to i16*
  %12 = load i16, i16* %11
  %13 = trunc i16 %12 to i15
  br label %src.addr.0.0.05.exit

src.addr.0.0.05.exit:                             ; preds = %src.addr.0.0.05.case.1, %src.addr.0.0.05.case.0
  %14 = phi i15 [ %9, %src.addr.0.0.05.case.0 ], [ %13, %src.addr.0.0.05.case.1 ]
  store i15 %14, i15* %dst.addr.0.0.06, align 2
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %3
  br i1 %exitcond, label %for.loop, label %copy.split
...
define void @kernel_Get_c([16 x %"struct.ap_int<15>.5"]*, [2 x [8 x i15]*]*, i64) {
entry:
  %3 = getelementptr [2 x [8 x i15]*], [2 x [8 x i15]*]* %1, i64 0, i64 0
  %4 = load [8 x i15]*, [8 x i15]** %3
  %5 = getelementptr [2 x [8 x i15]*], [2 x [8 x i15]*]* %1, i64 0, i64 1
  %6 = load [8 x i15]*, [8 x i15]** %5
  call void @_kernel_Get_c([16 x %"struct.ap_int<15>.5"]* %0, [8 x i15]* %4, [8 x i15]* %6, i64 %2)
  ret void
}

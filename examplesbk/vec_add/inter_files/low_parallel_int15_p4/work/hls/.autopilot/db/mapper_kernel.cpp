...
using hls::sim::Byte;
extern "C" void kernel(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<8>*, Byte<8>*, Byte<8>*, Byte<8>*, int, int, int, int, int, int, int, int, int, int, int, int);
extern "C" void apatb_kernel_hw(volatile void * __xlx_apatb_param_a_0, volatile void * __xlx_apatb_param_a_1, volatile void * __xlx_apatb_param_a_2, volatile void * __xlx_apatb_param_a_3, volatile void * __xlx_apatb_param_b_0, volatile void * __xlx_apatb_param_b_1, volatile void * __xlx_apatb_param_b_2, volatile void * __xlx_apatb_param_b_3, volatile void * __xlx_apatb_param_c_0, volatile void * __xlx_apatb_param_c_1, volatile void * __xlx_apatb_param_c_2, volatile void * __xlx_apatb_param_c_3) {
...
std::vector<Byte<8>> __xlx_c_0__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_c_0__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_c_0)[i]);
}
  int __xlx_size_param_c_0 = 1;
  int __xlx_offset_param_c_0 = 0;
  int __xlx_offset_byte_param_c_0 = 0*8;
  // Collect __xlx_c_1__tmp_vec
std::vector<Byte<8>> __xlx_c_1__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_c_1__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_c_1)[i]);
}
  int __xlx_size_param_c_1 = 1;
  int __xlx_offset_param_c_1 = 0;
  int __xlx_offset_byte_param_c_1 = 0*8;
  // Collect __xlx_c_2__tmp_vec
std::vector<Byte<8>> __xlx_c_2__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_c_2__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_c_2)[i]);
}
  int __xlx_size_param_c_2 = 1;
  int __xlx_offset_param_c_2 = 0;
  int __xlx_offset_byte_param_c_2 = 0*8;
  // Collect __xlx_c_3__tmp_vec
std::vector<Byte<8>> __xlx_c_3__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_c_3__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_c_3)[i]);
}
  int __xlx_size_param_c_3 = 1;
  int __xlx_offset_param_c_3 = 0;
  int __xlx_offset_byte_param_c_3 = 0*8;
  // DUT call
  kernel(__xlx_a_0__tmp_vec.data(), __xlx_a_1__tmp_vec.data(), __xlx_a_2__tmp_vec.data(), __xlx_a_3__tmp_vec.data(), __xlx_b_0__tmp_vec.data(), __xlx_b_1__tmp_vec.data(), __xlx_b_2__tmp_vec.data(), __xlx_b_3__tmp_vec.data(), __xlx_c_0__tmp_vec.data(), __xlx_c_1__tmp_vec.data(), __xlx_c_2__tmp_vec.data(), __xlx_c_3__tmp_vec.data(), __xlx_offset_byte_param_a_0, __xlx_offset_byte_param_a_1, __xlx_offset_byte_param_a_2, __xlx_offset_byte_param_a_3, __xlx_offset_byte_param_b_0, __xlx_offset_byte_param_b_1, __xlx_offset_byte_param_b_2, __xlx_offset_byte_param_b_3, __xlx_offset_byte_param_c_0, __xlx_offset_byte_param_c_1, __xlx_offset_byte_param_c_2, __xlx_offset_byte_param_c_3);
...
((Byte<8>*)__xlx_apatb_param_c_0)[i] = __xlx_c_0__tmp_vec[__xlx_offset_param_c_0+i];
}
// print __xlx_apatb_param_c_1
for (size_t i = 0; i < __xlx_size_param_c_1; ++i) {
((Byte<8>*)__xlx_apatb_param_c_1)[i] = __xlx_c_1__tmp_vec[__xlx_offset_param_c_1+i];
}
// print __xlx_apatb_param_c_2
for (size_t i = 0; i < __xlx_size_param_c_2; ++i) {
((Byte<8>*)__xlx_apatb_param_c_2)[i] = __xlx_c_2__tmp_vec[__xlx_offset_param_c_2+i];
}
// print __xlx_apatb_param_c_3
for (size_t i = 0; i < __xlx_size_param_c_3; ++i) {
((Byte<8>*)__xlx_apatb_param_c_3)[i] = __xlx_c_3__tmp_vec[__xlx_offset_param_c_3+i];
}
}

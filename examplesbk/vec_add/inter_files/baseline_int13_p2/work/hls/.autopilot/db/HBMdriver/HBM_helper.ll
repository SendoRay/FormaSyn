...
define void @_kernel_Set_c([8 x i13]*, [8 x i13]*, [16 x %"struct.ap_int<13>.5"]*, i64) {
entry:
  %4 = icmp eq [16 x %"struct.ap_int<13>.5"]* %2, null
...
for.loop:                                         ; preds = %dst.addr.0.0.06.exit, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [16 x %"struct.ap_int<13>.5"], [16 x %"struct.ap_int<13>.5"]* %2, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
  %dst.addr.0.0.06_0 = getelementptr [8 x i13], [8 x i13]* %0, i64 0, i64 %5
  %dst.addr.0.0.06_1 = getelementptr [8 x i13], [8 x i13]* %1, i64 0, i64 %5
  %7 = bitcast i13* %src.addr.0.0.05 to i16*
  %8 = load i16, i16* %7
...
dst.addr.0.0.06.case.0:                           ; preds = %for.loop
  store i13 %9, i13* %dst.addr.0.0.06_0, align 2
  br label %dst.addr.0.0.06.exit

dst.addr.0.0.06.case.1:                           ; preds = %for.loop
  %10 = icmp eq i64 %6, 1
  call void @llvm.assume(i1 %10)
  store i13 %9, i13* %dst.addr.0.0.06_1, align 2
  br label %dst.addr.0.0.06.exit
...
define void @kernel_Set_c([2 x [8 x i13]*]*, [16 x %"struct.ap_int<13>.5"]*, i64) {
entry:
  %3 = getelementptr [2 x [8 x i13]*], [2 x [8 x i13]*]* %0, i64 0, i64 0
  %4 = load [8 x i13]*, [8 x i13]** %3
  %5 = getelementptr [2 x [8 x i13]*], [2 x [8 x i13]*]* %0, i64 0, i64 1
  %6 = load [8 x i13]*, [8 x i13]** %5
  call void @_kernel_Set_c([8 x i13]* %4, [8 x i13]* %6, [16 x %"struct.ap_int<13>.5"]* %1, i64 %2)
  ret void
}

define void @_kernel_Get_c([16 x %"struct.ap_int<13>.5"]*, [8 x i13]*, [8 x i13]*, i64) {
entry:
  %4 = icmp eq [16 x %"struct.ap_int<13>.5"]* %0, null
  br i1 %4, label %ret, label %copy
...
for.loop:                                         ; preds = %src.addr.0.0.05.exit, %for.loop.lr.ph
  ...
  %5 = udiv i64 %for.loop.idx2, 2
  %6 = urem i64 %for.loop.idx2, 2
  %src.addr.0.0.05_0 = getelementptr [8 x i13], [8 x i13]* %1, i64 0, i64 %5
  %src.addr.0.0.05_1 = getelementptr [8 x i13], [8 x i13]* %2, i64 0, i64 %5
...
src.addr.0.0.05.case.0:                           ; preds = %for.loop
  %7 = bitcast i13* %src.addr.0.0.05_0 to i16*
  %8 = load i16, i16* %7
  %9 = trunc i16 %8 to i13
...
src.addr.0.0.05.case.1:                           ; preds = %for.loop
  %10 = icmp eq i64 %6, 1
  call void @llvm.assume(i1 %10)
  %11 = bitcast i13* %src.addr.0.0.05_1 to i16*
  %12 = load i16, i16* %11
  %13 = trunc i16 %12 to i13
  br label %src.addr.0.0.05.exit

src.addr.0.0.05.exit:                             ; preds = %src.addr.0.0.05.case.1, %src.addr.0.0.05.case.0
  %14 = phi i13 [ %9, %src.addr.0.0.05.case.0 ], [ %13, %src.addr.0.0.05.case.1 ]
...
define void @kernel_Get_c([16 x %"struct.ap_int<13>.5"]*, [2 x [8 x i13]*]*, i64) {
entry:
  %3 = getelementptr [2 x [8 x i13]*], [2 x [8 x i13]*]* %1, i64 0, i64 0
  %4 = load [8 x i13]*, [8 x i13]** %3
  %5 = getelementptr [2 x [8 x i13]*], [2 x [8 x i13]*]* %1, i64 0, i64 1
  %6 = load [8 x i13]*, [8 x i13]** %5
  call void @_kernel_Get_c([16 x %"struct.ap_int<13>.5"]* %0, [8 x i13]* %4, [8 x i13]* %6, i64 %2)
  ret void
}

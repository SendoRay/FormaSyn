; ModuleID = '/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @copy_in([16 x %"struct.ap_int<8>"]* nonnull %0, [2 x i8]* nonnull align 512 %a_copy_0, [2 x i8]* nonnull align 512 %a_copy_1, [2 x i8]* nonnull align 512 %a_copy_2, [2 x i8]* nonnull align 512 %a_copy_3, [2 x i8]* nonnull align 512 %a_copy_4, [2 x i8]* nonnull align 512 %a_copy_5, [2 x i8]* nonnull align 512 %a_copy_6, [2 x i8]* nonnull align 512 %a_copy_7, [16 x %"struct.ap_int<8>"]* nonnull %1, [2 x i8]* nonnull align 512 %b_copy_0, [2 x i8]* nonnull align 512 %b_copy_1, [2 x i8]* nonnull align 512 %b_copy_2, [2 x i8]* nonnull align 512 %b_copy_3, [2 x i8]* nonnull align 512 %b_copy_4, [2 x i8]* nonnull align 512 %b_copy_5, [2 x i8]* nonnull align 512 %b_copy_6, [2 x i8]* nonnull align 512 %b_copy_7, [16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* nonnull %2, [2 x i16]* nonnull align 512 %c_copy_0, [2 x i16]* nonnull align 512 %c_copy_1, [2 x i16]* nonnull align 512 %c_copy_2, [2 x i16]* nonnull align 512 %c_copy_3, [2 x i16]* nonnull align 512 %c_copy_4, [2 x i16]* nonnull align 512 %c_copy_5, [2 x i16]* nonnull align 512 %c_copy_6, [2 x i16]* nonnull align 512 %c_copy_7)
  ...
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_04, i32 999, i32 1, i32 1, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_15, i32 999, i32 1, i32 1, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_26, i32 999, i32 1, i32 1, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_37, i32 999, i32 1, i32 1, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_48, i32 999, i32 1, i32 1, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_59, i32 999, i32 1, i32 1, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_610, i32 999, i32 1, i32 1, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_711, i32 999, i32 1, i32 1, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_04, i32 998, i32 1, i32 0, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_15, i32 998, i32 1, i32 0, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_26, i32 998, i32 1, i32 0, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_37, i32 998, i32 1, i32 0, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_48, i32 998, i32 1, i32 0, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_59, i32 998, i32 1, i32 0, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_610, i32 998, i32 1, i32 0, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i8* %_711, i32 998, i32 1, i32 0, i1 false) ], !dbg !173
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_012, i32 999, i32 1, i32 1, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_113, i32 999, i32 1, i32 1, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_214, i32 999, i32 1, i32 1, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_315, i32 999, i32 1, i32 1, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_416, i32 999, i32 1, i32 1, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_517, i32 999, i32 1, i32 1, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_618, i32 999, i32 1, i32 1, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_719, i32 999, i32 1, i32 1, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_012, i32 998, i32 1, i32 0, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_113, i32 998, i32 1, i32 0, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_214, i32 998, i32 1, i32 0, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_315, i32 998, i32 1, i32 0, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_416, i32 998, i32 1, i32 0, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_517, i32 998, i32 1, i32 0, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_618, i32 998, i32 1, i32 0, i1 false) ], !dbg !174
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %_719, i32 998, i32 1, i32 0, i1 false) ], !dbg !174
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a16struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"([2 x i16]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.0" %dst_0, [2 x i16]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.1" %dst_1, [2 x i16]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.2" %dst_2, [2 x i16]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.3" %dst_3, [2 x i16]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.4" %dst_4, [2 x i16]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.5" %dst_5, [2 x i16]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.6" %dst_6, [2 x i16]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.7" %dst_7, [16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #4 {
entry:
  %0 = icmp eq [16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"([2 x i16]* %dst_0, [2 x i16]* %dst_1, [2 x i16]* %dst_2, [2 x i16]* %dst_3, [2 x i16]* %dst_4, [2 x i16]* %dst_5, [2 x i16]* %dst_6, [2 x i16]* %dst_7, [16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 16)
  br label %ret
...
entry:
  ...
  call void @"onebyonecpy_hls.p0a16struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"([2 x i16]* align 512 %_09, [2 x i16]* align 512 %_110, [2 x i16]* align 512 %_211, [2 x i16]* align 512 %_312, [2 x i16]* align 512 %_413, [2 x i16]* align 512 %_514, [2 x i16]* align 512 %_615, [2 x i16]* align 512 %_716, [16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %2)
  ret void
}
...
entry:
  ...
  call void @"onebyonecpy_hls.p0a16struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>.5"([16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %2, [2 x i16]* align 512 %_09, [2 x i16]* align 512 %_110, [2 x i16]* align 512 %_211, [2 x i16]* align 512 %_312, [2 x i16]* align 512 %_413, [2 x i16]* align 512 %_514, [2 x i16]* align 512 %_615, [2 x i16]* align 512 %_716)
  ret void
}
...
entry:
  ...
  %29 = bitcast i8* %28 to [16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]*
  call void @copy_out([16 x %"struct.ap_int<8>"]* %25, [2 x i8]* %0, [2 x i8]* %1, [2 x i8]* %2, [2 x i8]* %3, [2 x i8]* %4, [2 x i8]* %5, [2 x i8]* %6, [2 x i8]* %7, [16 x %"struct.ap_int<8>"]* %27, [2 x i8]* %8, [2 x i8]* %9, [2 x i8]* %10, [2 x i8]* %11, [2 x i8]* %12, [2 x i8]* %13, [2 x i8]* %14, [2 x i8]* %15, [16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %29, [2 x i16]* %16, [2 x i16]* %17, [2 x i16]* %18, [2 x i16]* %19, [2 x i16]* %20, [2 x i16]* %21, [2 x i16]* %22, [2 x i16]* %23)
  %30 = bitcast [16 x %"struct.ap_int<8>"]* %25 to %"struct.ap_int<8>"*
  %31 = bitcast [16 x %"struct.ap_int<8>"]* %27 to %"struct.ap_int<8>"*
  %32 = bitcast [16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %29 to %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"*
  call void @kernel_hw_stub(%"struct.ap_int<8>"* %30, %"struct.ap_int<8>"* %31, %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"* %32)
  call void @copy_in([16 x %"struct.ap_int<8>"]* %25, [2 x i8]* %0, [2 x i8]* %1, [2 x i8]* %2, [2 x i8]* %3, [2 x i8]* %4, [2 x i8]* %5, [2 x i8]* %6, [2 x i8]* %7, [16 x %"struct.ap_int<8>"]* %27, [2 x i8]* %8, [2 x i8]* %9, [2 x i8]* %10, [2 x i8]* %11, [2 x i8]* %12, [2 x i8]* %13, [2 x i8]* %14, [2 x i8]* %15, [16 x %"struct.ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>"]* %29, [2 x i16]* %16, [2 x i16]* %17, [2 x i16]* %18, [2 x i16]* %19, [2 x i16]* %20, [2 x i16]* %21, [2 x i16]* %22, [2 x i16]* %23)
...
!44 = distinct !DISubprogram(name: "kernel", linkageName: "_Z6kernelP6ap_intILi8EES1_P8ap_fixedILi16ELi7EL9ap_q_mode5EL9ap_o_mode3ELi0EE", scope: !45, file: !45, line: 5, type: !46, isLocal: false, isDefinition: true, scopeLine: 5, flags: DIFlagPrototyped, isOptimized: false, unit: !167, variables: !4)
!45 = !DIFile(filename: "kernel.cpp", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8")
...
!50 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/ap_int.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8")
!51 = !{!52, !87, !92, !96, !101}
...
!54 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/etc/ap_int_base.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8")
!55 = !{!56, !74, !76, !78}
...
!58 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/etc/ap_common.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8")
!59 = !{!60, !62, !66}
...
!109 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_fixed<16, 7, AP_TRN, AP_WRAP, 0>", file: !110, line: 18, size: 16, flags: DIFlagTypePassByValue, elements: !111, templateParams: !166, identifier: "_ZTS8ap_fixedILi16ELi7EL9ap_q_mode5EL9ap_o_mode3ELi0EE")
!110 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/ap_fixed.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8")
!111 = !{!112, !159}
!112 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !109, baseType: !113)
!113 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_fixed_base<16, 7, true, AP_TRN, AP_WRAP, 0>", file: !114, line: 110, size: 16, flags: DIFlagTypePassByValue, elements: !115, templateParams: !153, identifier: "_ZTS13ap_fixed_baseILi16ELi7ELb1EL9ap_q_mode5EL9ap_o_mode3ELi0EE")
!114 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/etc/ap_fixed_base.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8")
!115 = !{!116, !130, !131, !132, !144}
!116 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !113, baseType: !117)
!117 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<16, true>", file: !58, line: 530, size: 16, flags: DIFlagTypePassByValue, elements: !118, templateParams: !128, identifier: "_ZTS8ssdm_intILi16ELb1EE")
!118 = !{!119, !121, !125}
!119 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !117, file: !58, line: 532, baseType: !120, size: 16)
!120 = !DIBasicType(name: "short", size: 16, encoding: DW_ATE_signed)
!121 = !DISubprogram(name: "ssdm_int", scope: !117, file: !58, line: 533, type: !122, isLocal: false, isDefinition: false, scopeLine: 533, flags: DIFlagPrototyped, isOptimized: false)
!122 = !DISubroutineType(types: !123)
!123 = !{null, !124}
!124 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !117, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!125 = !DISubprogram(name: "ssdm_int", scope: !117, file: !58, line: 534, type: !126, isLocal: false, isDefinition: false, scopeLine: 534, flags: DIFlagPrototyped, isOptimized: false)
!126 = !DISubroutineType(types: !127)
!127 = !{null, !124, !120}
!128 = !{!129, !72}
!129 = !DITemplateValueParameter(name: "_AP_N", type: !71, value: i32 16)
!130 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !113, file: !114, line: 115, baseType: !75, flags: DIFlagStaticMember, extraData: i32 16)
!131 = !DIDerivedType(tag: DW_TAG_member, name: "iwidth", scope: !113, file: !114, line: 116, baseType: !75, flags: DIFlagStaticMember, extraData: i32 7)
!132 = !DIDerivedType(tag: DW_TAG_member, name: "qmode", scope: !113, file: !114, line: 117, baseType: !133, flags: DIFlagStaticMember, extraData: i32 5)
!133 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !134)
!134 = distinct !DICompositeType(tag: DW_TAG_enumeration_type, name: "ap_q_mode", file: !135, line: 54, size: 32, elements: !136, identifier: "_ZTS9ap_q_mode")
!135 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/etc/ap_decl.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8")
!136 = !{!137, !138, !139, !140, !141, !142, !143}
!137 = !DIEnumerator(name: "AP_RND", value: 0)
!138 = !DIEnumerator(name: "AP_RND_ZERO", value: 1)
!139 = !DIEnumerator(name: "AP_RND_MIN_INF", value: 2)
!140 = !DIEnumerator(name: "AP_RND_INF", value: 3)
!141 = !DIEnumerator(name: "AP_RND_CONV", value: 4)
!142 = !DIEnumerator(name: "AP_TRN", value: 5)
!143 = !DIEnumerator(name: "AP_TRN_ZERO", value: 6)
!144 = !DIDerivedType(tag: DW_TAG_member, name: "omode", scope: !113, file: !114, line: 118, baseType: !145, flags: DIFlagStaticMember, extraData: i32 3)
!145 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !146)
!146 = distinct !DICompositeType(tag: DW_TAG_enumeration_type, name: "ap_o_mode", file: !135, line: 76, size: 32, elements: !147, identifier: "_ZTS9ap_o_mode")
!147 = !{!148, !149, !150, !151, !152}
!148 = !DIEnumerator(name: "AP_SAT", value: 0)
!149 = !DIEnumerator(name: "AP_SAT_ZERO", value: 1)
!150 = !DIEnumerator(name: "AP_SAT_SYM", value: 2)
!151 = !DIEnumerator(name: "AP_WRAP", value: 3)
!152 = !DIEnumerator(name: "AP_WRAP_SM", value: 4)
!153 = !{!154, !155, !72, !156, !157, !158}
!154 = !DITemplateValueParameter(name: "_AP_W", type: !71, value: i32 16)
!155 = !DITemplateValueParameter(name: "_AP_I", type: !71, value: i32 7)
!156 = !DITemplateValueParameter(name: "_AP_Q", type: !134, value: i32 5)
!157 = !DITemplateValueParameter(name: "_AP_O", type: !146, value: i32 3)
!158 = !DITemplateValueParameter(name: "_AP_N", type: !71, value: i32 0)
!159 = !DISubprogram(name: "operator=", linkageName: "_ZN8ap_fixedILi16ELi7EL9ap_q_mode5EL9ap_o_mode3ELi0EEaSERKS2_", scope: !109, file: !110, line: 161, type: !160, isLocal: false, isDefinition: false, scopeLine: 161, flags: DIFlagPrototyped, isOptimized: false)
!160 = !DISubroutineType(types: !161)
!161 = !{!162, !163, !164}
!162 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !109, size: 64)
!163 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !109, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
!164 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !165, size: 64)
!165 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !109)
!166 = !{!154, !155, !156, !157, !158}
!167 = distinct !DICompileUnit(language: DW_LANG_C_plus_plus, file: !168, producer: "clang version 7.0.0 ", isOptimized: true, runtimeVersion: 0, emissionKind: FullDebug, enums: !169, retainedTypes: !170)
!168 = !DIFile(filename: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8/work/hls/.autopilot/db/kernel.pp.0.cpp", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_int15_p8")
!169 = !{!134, !146}
!170 = !{!109, !171, !172}
...
!173 = !DILocation(line: 15, column: 9, scope: !44)
!174 = !DILocation(line: 16, column: 9, scope: !44)

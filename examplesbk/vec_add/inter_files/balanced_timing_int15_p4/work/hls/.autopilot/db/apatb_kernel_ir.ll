; ModuleID = '/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_timing_int15_p4/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %c_copy_0 = alloca [4 x i15], align 512
  %c_copy_1 = alloca [4 x i15], align 512
  %c_copy_2 = alloca [4 x i15], align 512
  %c_copy_3 = alloca [4 x i15], align 512
  %_08 = getelementptr [4 x i15], [4 x i15]* %c_copy_0, i64 0, i64 0
  %_19 = getelementptr [4 x i15], [4 x i15]* %c_copy_1, i64 0, i64 0
  %_210 = getelementptr [4 x i15], [4 x i15]* %c_copy_2, i64 0, i64 0
  %_311 = getelementptr [4 x i15], [4 x i15]* %c_copy_3, i64 0, i64 0
  call void @copy_in([16 x %"struct.ap_int<8>"]* nonnull %0, [4 x i8]* nonnull align 512 %a_copy_0, [4 x i8]* nonnull align 512 %a_copy_1, [4 x i8]* nonnull align 512 %a_copy_2, [4 x i8]* nonnull align 512 %a_copy_3, [16 x %"struct.ap_int<8>"]* nonnull %1, [4 x i8]* nonnull align 512 %b_copy_0, [4 x i8]* nonnull align 512 %b_copy_1, [4 x i8]* nonnull align 512 %b_copy_2, [4 x i8]* nonnull align 512 %b_copy_3, [16 x %"struct.ap_int<15>"]* nonnull %2, [4 x i15]* nonnull align 512 %c_copy_0, [4 x i15]* nonnull align 512 %c_copy_1, [4 x i15]* nonnull align 512 %c_copy_2, [4 x i15]* nonnull align 512 %c_copy_3)
  ...
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_08, i32 999, i32 1, i32 1, i1 false) ], !dbg !175
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_19, i32 999, i32 1, i32 1, i1 false) ], !dbg !175
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_210, i32 999, i32 1, i32 1, i1 false) ], !dbg !175
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_311, i32 999, i32 1, i32 1, i1 false) ], !dbg !175
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_08, i32 998, i32 1, i32 0, i1 false) ], !dbg !175
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_19, i32 998, i32 1, i32 0, i1 false) ], !dbg !175
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_210, i32 998, i32 1, i32 0, i1 false) ], !dbg !175
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_311, i32 998, i32 1, i32 0, i1 false) ], !dbg !175
  call void @apatb_kernel_hw([4 x i8]* %a_copy_0, [4 x i8]* %a_copy_1, [4 x i8]* %a_copy_2, [4 x i8]* %a_copy_3, [4 x i8]* %b_copy_0, [4 x i8]* %b_copy_1, [4 x i8]* %b_copy_2, [4 x i8]* %b_copy_3, [4 x i15]* %c_copy_0, [4 x i15]* %c_copy_1, [4 x i15]* %c_copy_2, [4 x i15]* %c_copy_3)
  call void @copy_back([16 x %"struct.ap_int<8>"]* %0, [4 x i8]* %a_copy_0, [4 x i8]* %a_copy_1, [4 x i8]* %a_copy_2, [4 x i8]* %a_copy_3, [16 x %"struct.ap_int<8>"]* %1, [4 x i8]* %b_copy_0, [4 x i8]* %b_copy_1, [4 x i8]* %b_copy_2, [4 x i8]* %b_copy_3, [16 x %"struct.ap_int<15>"]* %2, [4 x i15]* %c_copy_0, [4 x i15]* %c_copy_1, [4 x i15]* %c_copy_2, [4 x i15]* %c_copy_3)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_int<15>"([4 x i15]* nocapture "orig.arg.no"="0" "unpacked"="0.0.0" %dst_0, [4 x i15]* nocapture "orig.arg.no"="0" "unpacked"="0.0.1" %dst_1, [4 x i15]* nocapture "orig.arg.no"="0" "unpacked"="0.0.2" %dst_2, [4 x i15]* nocapture "orig.arg.no"="0" "unpacked"="0.0.3" %dst_3, [16 x %"struct.ap_int<15>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
...
for.loop:                                         ; preds = %dst.addr.0.0.06.exit, %for.loop.lr.ph
  ...
  %dst.addr.0.0.06_0 = getelementptr [4 x i15], [4 x i15]* %dst_0, i64 0, i64 %1
  %dst.addr.0.0.06_1 = getelementptr [4 x i15], [4 x i15]* %dst_1, i64 0, i64 %1
  %dst.addr.0.0.06_2 = getelementptr [4 x i15], [4 x i15]* %dst_2, i64 0, i64 %1
  %dst.addr.0.0.06_3 = getelementptr [4 x i15], [4 x i15]* %dst_3, i64 0, i64 %1
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a16struct.ap_int<15>"([4 x i15]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.0" %dst_0, [4 x i15]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.1" %dst_1, [4 x i15]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.2" %dst_2, [4 x i15]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.3" %dst_3, [16 x %"struct.ap_int<15>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #4 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<15>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16struct.ap_int<15>"([4 x i15]* %dst_0, [4 x i15]* %dst_1, [4 x i15]* %dst_2, [4 x i15]* %dst_3, [16 x %"struct.ap_int<15>"]* nonnull %src, i64 16)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_in([16 x %"struct.ap_int<8>"]* noalias readonly "orig.arg.no"="0" "unpacked"="0", [4 x i8]* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %_0, [4 x i8]* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %_1, [4 x i8]* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %_2, [4 x i8]* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0.3" %_3, [16 x %"struct.ap_int<8>"]* noalias readonly "orig.arg.no"="2" "unpacked"="2", [4 x i8]* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_01, [4 x i8]* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_12, [4 x i8]* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.2" %_23, [4 x i8]* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.3" %_34, [16 x %"struct.ap_int<15>"]* noalias readonly "orig.arg.no"="4" "unpacked"="4", [4 x i15]* noalias nocapture align 512 "orig.arg.no"="5" "unpacked"="5.0.0" %_05, [4 x i15]* noalias nocapture align 512 "orig.arg.no"="5" "unpacked"="5.0.1" %_16, [4 x i15]* noalias nocapture align 512 "orig.arg.no"="5" "unpacked"="5.0.2" %_27, [4 x i15]* noalias nocapture align 512 "orig.arg.no"="5" "unpacked"="5.0.3" %_38) #5 {
entry:
  ...
  call void @"onebyonecpy_hls.p0a16struct.ap_int<15>"([4 x i15]* align 512 %_05, [4 x i15]* align 512 %_16, [4 x i15]* align 512 %_27, [4 x i15]* align 512 %_38, [16 x %"struct.ap_int<15>"]* %2)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_int<8>.25"([16 x %"struct.ap_int<8>"]* "orig.arg.no"="0" "unpacked"="0" %dst, [4 x i8]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, [4 x i8]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.1" %src_1, [4 x i8]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.2" %src_2, [4 x i8]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.3" %src_3, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_int<15>.8"([16 x %"struct.ap_int<15>"]* "orig.arg.no"="0" "unpacked"="0" %dst, [4 x i15]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, [4 x i15]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.1" %src_1, [4 x i15]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.2" %src_2, [4 x i15]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.3" %src_3, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
...
for.loop:                                         ; preds = %src.addr.0.0.05.exit, %for.loop.lr.ph
  ...
  %1 = udiv i64 %for.loop.idx2, 4
  %2 = urem i64 %for.loop.idx2, 4
  %src.addr.0.0.05_0 = getelementptr [4 x i15], [4 x i15]* %src_0, i64 0, i64 %1
  %src.addr.0.0.05_1 = getelementptr [4 x i15], [4 x i15]* %src_1, i64 0, i64 %1
  %src.addr.0.0.05_2 = getelementptr [4 x i15], [4 x i15]* %src_2, i64 0, i64 %1
  %src.addr.0.0.05_3 = getelementptr [4 x i15], [4 x i15]* %src_3, i64 0, i64 %1
...
src.addr.0.0.05.case.3:                           ; preds = %for.loop
  ...
  %13 = bitcast i15* %src.addr.0.0.05_3 to i16*
  %14 = load i16, i16* %13
  %15 = trunc i16 %14 to i15
  br label %src.addr.0.0.05.exit

src.addr.0.0.05.exit:                             ; preds = %src.addr.0.0.05.case.3, %src.addr.0.0.05.case.2, %src.addr.0.0.05.case.1, %src.addr.0.0.05.case.0
  %16 = phi i15 [ %5, %src.addr.0.0.05.case.0 ], [ %8, %src.addr.0.0.05.case.1 ], [ %11, %src.addr.0.0.05.case.2 ], [ %15, %src.addr.0.0.05.case.3 ]
  store i15 %16, i15* %dst.addr.0.0.06, align 2
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a16struct.ap_int<15>.5"([16 x %"struct.ap_int<15>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, [4 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, [4 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %src_1, [4 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %src_2, [4 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.3" %src_3) #4 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<15>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16struct.ap_int<15>.8"([16 x %"struct.ap_int<15>"]* nonnull %dst, [4 x i15]* %src_0, [4 x i15]* %src_1, [4 x i15]* %src_2, [4 x i15]* %src_3, i64 16)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_out([16 x %"struct.ap_int<8>"]* noalias "orig.arg.no"="0" "unpacked"="0", [4 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %_0, [4 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %_1, [4 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %_2, [4 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.3" %_3, [16 x %"struct.ap_int<8>"]* noalias "orig.arg.no"="2" "unpacked"="2", [4 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_01, [4 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_12, [4 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.2" %_23, [4 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.3" %_34, [16 x %"struct.ap_int<15>"]* noalias "orig.arg.no"="4" "unpacked"="4", [4 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="5" "unpacked"="5.0.0" %_05, [4 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="5" "unpacked"="5.0.1" %_16, [4 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="5" "unpacked"="5.0.2" %_27, [4 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="5" "unpacked"="5.0.3" %_38) #6 {
entry:
  ...
  call void @"onebyonecpy_hls.p0a16struct.ap_int<15>.5"([16 x %"struct.ap_int<15>"]* %2, [4 x i15]* align 512 %_05, [4 x i15]* align 512 %_16, [4 x i15]* align 512 %_27, [4 x i15]* align 512 %_38)
  ret void
}
...
declare void @apatb_kernel_hw([4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i15]*, [4 x i15]*, [4 x i15]*, [4 x i15]*)
...
define void @kernel_hw_stub_wrapper([4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i8]*, [4 x i15]*, [4 x i15]*, [4 x i15]*, [4 x i15]*) #7 {
entry:
  ...
  %17 = bitcast i8* %16 to [16 x %"struct.ap_int<15>"]*
  call void @copy_out([16 x %"struct.ap_int<8>"]* %13, [4 x i8]* %0, [4 x i8]* %1, [4 x i8]* %2, [4 x i8]* %3, [16 x %"struct.ap_int<8>"]* %15, [4 x i8]* %4, [4 x i8]* %5, [4 x i8]* %6, [4 x i8]* %7, [16 x %"struct.ap_int<15>"]* %17, [4 x i15]* %8, [4 x i15]* %9, [4 x i15]* %10, [4 x i15]* %11)
  %18 = bitcast [16 x %"struct.ap_int<8>"]* %13 to %"struct.ap_int<8>"*
  %19 = bitcast [16 x %"struct.ap_int<8>"]* %15 to %"struct.ap_int<8>"*
  %20 = bitcast [16 x %"struct.ap_int<15>"]* %17 to %"struct.ap_int<15>"*
  call void @kernel_hw_stub(%"struct.ap_int<8>"* %18, %"struct.ap_int<8>"* %19, %"struct.ap_int<15>"* %20)
  call void @copy_in([16 x %"struct.ap_int<8>"]* %13, [4 x i8]* %0, [4 x i8]* %1, [4 x i8]* %2, [4 x i8]* %3, [16 x %"struct.ap_int<8>"]* %15, [4 x i8]* %4, [4 x i8]* %5, [4 x i8]* %6, [4 x i8]* %7, [16 x %"struct.ap_int<15>"]* %17, [4 x i15]* %8, [4 x i15]* %9, [4 x i15]* %10, [4 x i15]* %11)
...
!23 = !{!24, !8, !26}
!24 = !{!25}
!25 = !{!"2.0", [16 x i15]* null}
!26 = !{!27, !28, !29, !30}
!27 = !{!"2.0.0", [4 x i15]* null}
!28 = !{!"2.0.1", [4 x i15]* null}
!29 = !{!"2.0.2", [4 x i15]* null}
!30 = !{!"2.0.3", [4 x i15]* null}
!31 = !DILocation(line: 14, column: 9, scope: !32)
!32 = distinct !DISubprogram(name: "kernel", linkageName: "_Z6kernelP6ap_intILi8EES1_PS_ILi15EE", scope: !33, file: !33, line: 5, type: !34, isLocal: false, isDefinition: true, scopeLine: 5, flags: DIFlagPrototyped, isOptimized: false, unit: !144, variables: !4)
!33 = !DIFile(filename: "kernel.cpp", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_timing_int15_p4")
...
!38 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/ap_int.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_timing_int15_p4")
!39 = !{!40, !75, !80, !84, !89}
...
!42 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/etc/ap_int_base.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_timing_int15_p4")
!43 = !{!44, !62, !64, !66}
...
!46 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/etc/ap_common.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_timing_int15_p4")
!47 = !{!48, !50, !54}
...
!97 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int<15>", file: !38, line: 18, size: 16, flags: DIFlagTypePassByValue, elements: !98, templateParams: !143, identifier: "_ZTS6ap_intILi15EE")
!98 = !{!99, !127, !131, !134, !137}
!99 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !97, baseType: !100)
!100 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<15, true>", file: !42, line: 124, size: 16, flags: DIFlagTypePassByValue, elements: !101, templateParams: !125, identifier: "_ZTS11ap_int_baseILi15ELb1EE")
!101 = !{!102, !116, !117, !118}
!102 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !100, baseType: !103)
!103 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<15, true>", file: !46, line: 530, size: 16, flags: DIFlagTypePassByValue, elements: !104, templateParams: !114, identifier: "_ZTS8ssdm_intILi15ELb1EE")
!104 = !{!105, !107, !111}
!105 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !103, file: !46, line: 532, baseType: !106, size: 15, align: 16)
!106 = !DIBasicType(name: "int15", size: 15, encoding: DW_ATE_signed)
...
!113 = !{null, !110, !106}
!114 = !{!115, !60}
!115 = !DITemplateValueParameter(name: "_AP_N", type: !59, value: i32 15)
!116 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !100, file: !42, line: 148, baseType: !63, flags: DIFlagStaticMember, extraData: i32 15)
...
!118 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi15ELb1EEaSERKS0_", scope: !100, file: !42, line: 479, type: !119, isLocal: false, isDefinition: false, scopeLine: 479, flags: DIFlagPrototyped, isOptimized: false)
...
!125 = !{!126, !60}
!126 = !DITemplateValueParameter(name: "_AP_W", type: !59, value: i32 15)
...
!136 = !{null, !130, !87}
!137 = !DISubprogram(name: "operator=", linkageName: "_ZN6ap_intILi15EEaSERKS0_", scope: !97, file: !38, line: 154, type: !138, isLocal: false, isDefinition: false, scopeLine: 154, flags: DIFlagPrototyped, isOptimized: false)
...
!145 = !DIFile(filename: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_timing_int15_p4/work/hls/.autopilot/db/kernel.pp.0.cpp", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/balanced_timing_int15_p4")
!146 = !{!147}

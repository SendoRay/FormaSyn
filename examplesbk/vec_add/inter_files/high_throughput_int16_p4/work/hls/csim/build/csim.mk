...
HLS_SOURCES = ../../../../kernel_tb.cpp ../../../../kernel.cpp
...
$(ObjDir)/kernel_tb.o: ../../../../kernel_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../kernel_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/kernel_tb.d

$(ObjDir)/kernel.o: ../../../../kernel.cpp $(ObjDir)/.dir csim.mk

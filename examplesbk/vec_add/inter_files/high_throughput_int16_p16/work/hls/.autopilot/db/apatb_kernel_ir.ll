; ModuleID = '/home/chengzhy/FormaSyn/examples/vec_add/inter_files/high_throughput_int16_p16/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_kernel_ir(%"struct.ap_int<8>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" "maxi" %a, %"struct.ap_int<8>"* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="16" "maxi" %b, %"struct.ap_int<16>"* noalias nocapture nonnull "fpga.decayed.dim.hint"="16" "maxi" %c) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in([16 x %"struct.ap_int<8>"]* nonnull %0, [16 x i8]* nonnull align 512 %a_copy, [16 x %"struct.ap_int<8>"]* nonnull %1, [16 x i8]* nonnull align 512 %b_copy, [16 x %"struct.ap_int<16>"]* nonnull %2, [16 x i16]* nonnull align 512 %c_copy)
  call void @apatb_kernel_hw([16 x i8]* %a_copy, [16 x i8]* %b_copy, [16 x i16]* %c_copy)
  call void @copy_back([16 x %"struct.ap_int<8>"]* %0, [16 x i8]* %a_copy, [16 x %"struct.ap_int<8>"]* %1, [16 x i8]* %b_copy, [16 x %"struct.ap_int<16>"]* %2, [16 x i16]* %c_copy)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_in([16 x %"struct.ap_int<8>"]* noalias readonly "unpacked"="0", [16 x i8]* noalias nocapture align 512 "unpacked"="1.0", [16 x %"struct.ap_int<8>"]* noalias readonly "unpacked"="2", [16 x i8]* noalias nocapture align 512 "unpacked"="3.0", [16 x %"struct.ap_int<16>"]* noalias readonly "unpacked"="4", [16 x i16]* noalias nocapture align 512 "unpacked"="5.0") unnamed_addr #1 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a16struct.ap_int<16>"([16 x i16]* align 512 %5, [16 x %"struct.ap_int<16>"]* %4)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a16struct.ap_int<16>"([16 x i16]* noalias nocapture align 512 "unpacked"="0.0" %dst, [16 x %"struct.ap_int<16>"]* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<16>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16struct.ap_int<16>"([16 x i16]* %dst, [16 x %"struct.ap_int<16>"]* nonnull %src, i64 16)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_int<16>"([16 x i16]* nocapture "unpacked"="0.0" %dst, [16 x %"struct.ap_int<16>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #2 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<16>"]* %src, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([16 x %"struct.ap_int<8>"]* noalias "unpacked"="0", [16 x i8]* noalias nocapture readonly align 512 "unpacked"="1.0", [16 x %"struct.ap_int<8>"]* noalias "unpacked"="2", [16 x i8]* noalias nocapture readonly align 512 "unpacked"="3.0", [16 x %"struct.ap_int<16>"]* noalias "unpacked"="4", [16 x i16]* noalias nocapture readonly align 512 "unpacked"="5.0") unnamed_addr #4 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0a16struct.ap_int<16>.5"([16 x %"struct.ap_int<16>"]* %4, [16 x i16]* align 512 %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a16struct.ap_int<16>.5"([16 x %"struct.ap_int<16>"]* noalias "unpacked"="0" %dst, [16 x i16]* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #3 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<16>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16struct.ap_int<16>.8"([16 x %"struct.ap_int<16>"]* nonnull %dst, [16 x i16]* %src, i64 16)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_int<16>.8"([16 x %"struct.ap_int<16>"]* "unpacked"="0" %dst, [16 x i16]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #2 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<16>"]* %dst, null
  br i1 %0, label %ret, label %copy
...
entry:
  ...
  %8 = bitcast i8* %7 to [16 x %"struct.ap_int<16>"]*
  call void @copy_out([16 x %"struct.ap_int<8>"]* %4, [16 x i8]* %0, [16 x %"struct.ap_int<8>"]* %6, [16 x i8]* %1, [16 x %"struct.ap_int<16>"]* %8, [16 x i16]* %2)
  %9 = bitcast [16 x %"struct.ap_int<8>"]* %4 to %"struct.ap_int<8>"*
  %10 = bitcast [16 x %"struct.ap_int<8>"]* %6 to %"struct.ap_int<8>"*
  %11 = bitcast [16 x %"struct.ap_int<16>"]* %8 to %"struct.ap_int<16>"*
  call void @kernel_hw_stub(%"struct.ap_int<8>"* %9, %"struct.ap_int<8>"* %10, %"struct.ap_int<16>"* %11)
  call void @copy_in([16 x %"struct.ap_int<8>"]* %4, [16 x i8]* %0, [16 x %"struct.ap_int<8>"]* %6, [16 x i8]* %1, [16 x %"struct.ap_int<16>"]* %8, [16 x i16]* %2)
  call void @free(i8* %3)
  call void @free(i8* %5)
  call void @free(i8* %7)
  ret void

module ldpc_cnu (
    ...
    // ----- BRAM memories -----
    reg [1:0] sign_out_bank0 [0:15];
    reg [1:0] sign_out_bank1 [0:15];
    reg [1:0] sign_out_bank2 [0:15];
    reg [1:0] sign_out_bank3 [0:15];
    reg [2:0] min_out_bank0 [0:15];
    reg [2:0] min_out_bank1 [0:15];
    reg [2:0] min_out_bank2 [0:15];
    reg [2:0] min_out_bank3 [0:15];

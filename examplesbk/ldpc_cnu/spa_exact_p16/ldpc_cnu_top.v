module ldpc_cnu (
    ...
    reg [1:0] sign_out_bank8 [0:7];
    reg [1:0] sign_out_bank9 [0:7];
    reg [1:0] sign_out_bank10 [0:7];
    reg [1:0] sign_out_bank11 [0:7];
    reg [1:0] sign_out_bank12 [0:7];
    reg [1:0] sign_out_bank13 [0:7];
    reg [1:0] sign_out_bank14 [0:7];
    reg [1:0] sign_out_bank15 [0:7];
    ...
    reg [2:0] min_out_bank8 [0:7];
    reg [2:0] min_out_bank9 [0:7];
    reg [2:0] min_out_bank10 [0:7];
    reg [2:0] min_out_bank11 [0:7];
    reg [2:0] min_out_bank12 [0:7];
    reg [2:0] min_out_bank13 [0:7];
    reg [2:0] min_out_bank14 [0:7];
    reg [2:0] min_out_bank15 [0:7];

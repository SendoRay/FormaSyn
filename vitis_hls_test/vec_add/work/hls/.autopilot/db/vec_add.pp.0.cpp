...
# 2 "<built-in>" 2
# 1 "vec_add.cpp" 2
__attribute__((sdx_kernel("vec_add", 0))) void vec_add(const int a[16], const int b[16], int c[16]) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=vec_add
# 1 "vec_add.cpp"

#pragma HLS PIPELINE II=1
 VITIS_LOOP_3_1: for (int i = 0; i < 16; i++) {
            c[i] = a[i] + b[i];
        }
    }

...
HLS_SOURCES = ../../../../vec_add_tb.cpp ../../../../vec_add.cpp
...
$(ObjDir)/vec_add_tb.o: ../../../../vec_add_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../vec_add_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/vec_add_tb.d

$(ObjDir)/vec_add.o: ../../../../vec_add.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../vec_add.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/vec_add.d

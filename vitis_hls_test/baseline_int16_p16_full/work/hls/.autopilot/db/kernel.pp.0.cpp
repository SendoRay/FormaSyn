...
__attribute__((sdx_kernel("kernel", 0))) void kernel(ap_int<8> x_in, ap_int<8>& y_out_scale);
# 2 "kernel.cpp" 2
# 1 "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/ap_int.h" 1
# 3 "kernel.cpp" 2
...
#pragma HLS INTERFACE s_axilite port=y_out_scale bundle=control
...
#pragma HLS ARRAY_PARTITION variable=coeffs complete
 ...
 VITIS_LOOP_20_1: for (int i = 15; i > 0; i--) {
#pragma HLS UNROLL
 taps[i] = taps[i-1];
    }
    taps[0] = x_in;
...
#pragma HLS ARRAY_PARTITION variable=products complete
 ...
 VITIS_LOOP_30_2: for (int i = 0; i < 16; i++) {
#pragma HLS UNROLL

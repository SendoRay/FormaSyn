...
#define AUTOTB_TVIN_y_out_scale "../tv/cdatafile/c.kernel.autotvin_y_out_scale.dat"
#define AUTOTB_TVOUT_y_out_scale "../tv/cdatafile/c.kernel.autotvout_y_out_scale.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_y_out_scale "../tv/rtldatafile/rtl.kernel.autotvout_y_out_scale.dat"
...
extern "C"
void kernel_hw_stub_wrapper(hls::sim::Byte<1>*, void*);

extern "C"
void apatb_kernel_hw(hls::sim::Byte<1>* __xlx_apatb_param_x_in, void* __xlx_apatb_param_y_out_scale)
{
  ...
  static hls::sim::Register port1 {
    ...
    .width = 8,
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_y_out_scale),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_y_out_scale),
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_y_out_scale),
#endif
  };
  port1.param = __xlx_apatb_param_y_out_scale;
  ...
  try {
    ...
    kernel_hw_stub_wrapper(__xlx_apatb_param_x_in, __xlx_apatb_param_y_out_scale);

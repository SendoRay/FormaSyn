...
`define TV_OUT_x_in ""
`define TV_IN_y_out_scale ""
`define TV_OUT_y_out_scale "../tv/rtldatafile/rtl.kernel.autotvout_y_out_scale.dat"
    ...
    mem_model_pages#(8,8) mem_blk_pages_control_x_in;
    mem_model_pages#(8,8) mem_blk_pages_control_y_out_scale;
...
misc_if.dut2tb_ap_done = 0;
        ...
        mem_blk_pages_control_x_in = mem_model_pages#(8,8)::type_id::create("mem_blk_pages_control_x_in");
        mem_blk_pages_control_x_in.tvinload_pagechk_atinit(fpath, 1*((8+7)/8), 0, 16, "");
        fpath.delete;


        mem_blk_pages_control_y_out_scale = mem_model_pages#(8,8)::type_id::create("mem_blk_pages_control_y_out_scale");
        mem_blk_pages_control_y_out_scale.init_pages(trans_num_total, 1*((8+7)/8), 24);
        mem_blk_pages_control_y_out_scale.tvoutdump_atinit(`TV_OUT_y_out_scale);
    ...
    virtual function void write_axi_rtr_control(axi_pkg::axi_transfer tr);
        ...
        if(tr.addr == 0 && tr.len == 0) begin
            ...
            mem_blk_pages_control_y_out_scale.write_elems_frontpage(tr.data, tr.byte_addr);
        end
    endfunction
endclass
`endif

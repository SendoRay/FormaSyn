...
import vec_add_subsystem_pkg::*;
`include "vec_add_subsys_test_sequence_lib.sv"
`include "vec_add_test_lib.sv"


module sv_module_top;


    misc_interface              misc_if ( .clock(apatb_vec_add_top.AESL_clock), .reset(apatb_vec_add_top.AESL_reset) );
    assign misc_if.dut2tb_ap_ready = apatb_vec_add_top.AESL_inst_vec_add.ap_ready;
    assign misc_if.dut2tb_ap_done_kernel = apatb_vec_add_top.AESL_inst_vec_add.ap_done;
    initial begin
    ...
    assign axi_control_if.AWREADY = apatb_vec_add_top.control_AWREADY;
    assign apatb_vec_add_top.control_WVALID = axi_control_if.WVALID;
    assign axi_control_if.WREADY = apatb_vec_add_top.control_WREADY;
    assign apatb_vec_add_top.control_WDATA = axi_control_if.WDATA;
    assign apatb_vec_add_top.control_WSTRB = axi_control_if.WSTRB;
    assign apatb_vec_add_top.control_ARADDR = axi_control_if.ARADDR;
    assign apatb_vec_add_top.control_ARVALID = axi_control_if.ARVALID;
    assign axi_control_if.ARREADY = apatb_vec_add_top.control_ARREADY;
    assign axi_control_if.RVALID = apatb_vec_add_top.control_RVALID;
    assign apatb_vec_add_top.control_RREADY = axi_control_if.RREADY;
    assign axi_control_if.RDATA = apatb_vec_add_top.control_RDATA;
    assign axi_control_if.RRESP = apatb_vec_add_top.control_RRESP;
    assign axi_control_if.BVALID = apatb_vec_add_top.control_BVALID;
    assign apatb_vec_add_top.control_BREADY = axi_control_if.BREADY;
    assign axi_control_if.BRESP = apatb_vec_add_top.control_BRESP;

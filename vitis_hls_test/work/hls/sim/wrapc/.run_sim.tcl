...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "vec_add.autotvin.dat"
	set constFileTvOut       "vec_add.autotvout.dat"
	set constFileHdlTvIn     "vec_add.autohdltvin.dat"
	set constFileHdlTvOut    "vec_add.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

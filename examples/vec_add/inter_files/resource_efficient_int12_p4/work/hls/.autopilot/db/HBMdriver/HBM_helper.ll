...
%"struct.ap_int<12>.5" = type { %"struct.ap_int_base<12, true>.4" }
%"struct.ap_int_base<12, true>.4" = type { %"struct.ssdm_int<12, true>.3" }
%"struct.ssdm_int<12, true>.3" = type { i12 }
...
define void @_kernel_Set_c([4 x i12]*, [4 x i12]*, [4 x i12]*, [4 x i12]*, [16 x %"struct.ap_int<12>.5"]*, i64) {
entry:
  %6 = icmp eq [16 x %"struct.ap_int<12>.5"]* %4, null
...
for.loop:                                         ; preds = %dst.addr.0.0.06.exit, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [16 x %"struct.ap_int<12>.5"], [16 x %"struct.ap_int<12>.5"]* %4, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
  %dst.addr.0.0.06_0 = getelementptr [4 x i12], [4 x i12]* %0, i64 0, i64 %7
  %dst.addr.0.0.06_1 = getelementptr [4 x i12], [4 x i12]* %1, i64 0, i64 %7
  %dst.addr.0.0.06_2 = getelementptr [4 x i12], [4 x i12]* %2, i64 0, i64 %7
  %dst.addr.0.0.06_3 = getelementptr [4 x i12], [4 x i12]* %3, i64 0, i64 %7
  %9 = bitcast i12* %src.addr.0.0.05 to i16*
  %10 = load i16, i16* %9
...
dst.addr.0.0.06.case.0:                           ; preds = %for.loop
  store i12 %11, i12* %dst.addr.0.0.06_0, align 2
  br label %dst.addr.0.0.06.exit

dst.addr.0.0.06.case.1:                           ; preds = %for.loop
  store i12 %11, i12* %dst.addr.0.0.06_1, align 2
  br label %dst.addr.0.0.06.exit

dst.addr.0.0.06.case.2:                           ; preds = %for.loop
  store i12 %11, i12* %dst.addr.0.0.06_2, align 2
  br label %dst.addr.0.0.06.exit

dst.addr.0.0.06.case.3:                           ; preds = %for.loop
  %12 = icmp eq i64 %8, 3
  call void @llvm.assume(i1 %12)
  store i12 %11, i12* %dst.addr.0.0.06_3, align 2
  br label %dst.addr.0.0.06.exit
...
define void @kernel_Set_c([4 x [4 x i12]*]*, [16 x %"struct.ap_int<12>.5"]*, i64) {
entry:
  %3 = getelementptr [4 x [4 x i12]*], [4 x [4 x i12]*]* %0, i64 0, i64 0
  %4 = load [4 x i12]*, [4 x i12]** %3
  %5 = getelementptr [4 x [4 x i12]*], [4 x [4 x i12]*]* %0, i64 0, i64 1
  %6 = load [4 x i12]*, [4 x i12]** %5
  %7 = getelementptr [4 x [4 x i12]*], [4 x [4 x i12]*]* %0, i64 0, i64 2
  %8 = load [4 x i12]*, [4 x i12]** %7
  %9 = getelementptr [4 x [4 x i12]*], [4 x [4 x i12]*]* %0, i64 0, i64 3
  %10 = load [4 x i12]*, [4 x i12]** %9
  call void @_kernel_Set_c([4 x i12]* %4, [4 x i12]* %6, [4 x i12]* %8, [4 x i12]* %10, [16 x %"struct.ap_int<12>.5"]* %1, i64 %2)
  ret void
}

define void @_kernel_Get_c([16 x %"struct.ap_int<12>.5"]*, [4 x i12]*, [4 x i12]*, [4 x i12]*, [4 x i12]*, i64) {
entry:
  %6 = icmp eq [16 x %"struct.ap_int<12>.5"]* %0, null
  br i1 %6, label %ret, label %copy
...
for.loop:                                         ; preds = %src.addr.0.0.05.exit, %for.loop.lr.ph
  ...
  %7 = udiv i64 %for.loop.idx2, 4
  %8 = urem i64 %for.loop.idx2, 4
  %src.addr.0.0.05_0 = getelementptr [4 x i12], [4 x i12]* %1, i64 0, i64 %7
  %src.addr.0.0.05_1 = getelementptr [4 x i12], [4 x i12]* %2, i64 0, i64 %7
  %src.addr.0.0.05_2 = getelementptr [4 x i12], [4 x i12]* %3, i64 0, i64 %7
  %src.addr.0.0.05_3 = getelementptr [4 x i12], [4 x i12]* %4, i64 0, i64 %7
  %dst.addr.0.0.06 = getelementptr [16 x %"struct.ap_int<12>.5"], [16 x %"struct.ap_int<12>.5"]* %0, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
...
src.addr.0.0.05.case.0:                           ; preds = %for.loop
  %9 = bitcast i12* %src.addr.0.0.05_0 to i16*
  %10 = load i16, i16* %9
  %11 = trunc i16 %10 to i12
  br label %src.addr.0.0.05.exit

src.addr.0.0.05.case.1:                           ; preds = %for.loop
  %12 = bitcast i12* %src.addr.0.0.05_1 to i16*
  %13 = load i16, i16* %12
  %14 = trunc i16 %13 to i12
  br label %src.addr.0.0.05.exit

src.addr.0.0.05.case.2:                           ; preds = %for.loop
  %15 = bitcast i12* %src.addr.0.0.05_2 to i16*
  %16 = load i16, i16* %15
  %17 = trunc i16 %16 to i12
  br label %src.addr.0.0.05.exit

src.addr.0.0.05.case.3:                           ; preds = %for.loop
  %18 = icmp eq i64 %8, 3
  call void @llvm.assume(i1 %18)
  %19 = bitcast i12* %src.addr.0.0.05_3 to i16*
  %20 = load i16, i16* %19
...
src.addr.0.0.05.exit:                             ; preds = %src.addr.0.0.05.case.3, %src.addr.0.0.05.case.2, %src.addr.0.0.05.case.1, %src.addr.0.0.05.case.0
  %22 = phi i12 [ %11, %src.addr.0.0.05.case.0 ], [ %14, %src.addr.0.0.05.case.1 ], [ %17, %src.addr.0.0.05.case.2 ], [ %21, %src.addr.0.0.05.case.3 ]
  store i12 %22, i12* %dst.addr.0.0.06, align 2
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %5
  br i1 %exitcond, label %for.loop, label %copy.split
...
define void @kernel_Get_c([16 x %"struct.ap_int<12>.5"]*, [4 x [4 x i12]*]*, i64) {
entry:
  %3 = getelementptr [4 x [4 x i12]*], [4 x [4 x i12]*]* %1, i64 0, i64 0
  %4 = load [4 x i12]*, [4 x i12]** %3
  %5 = getelementptr [4 x [4 x i12]*], [4 x [4 x i12]*]* %1, i64 0, i64 1
  %6 = load [4 x i12]*, [4 x i12]** %5
  %7 = getelementptr [4 x [4 x i12]*], [4 x [4 x i12]*]* %1, i64 0, i64 2
  %8 = load [4 x i12]*, [4 x i12]** %7
  %9 = getelementptr [4 x [4 x i12]*], [4 x [4 x i12]*]* %1, i64 0, i64 3
  %10 = load [4 x i12]*, [4 x i12]** %9
  call void @_kernel_Get_c([16 x %"struct.ap_int<12>.5"]* %0, [4 x i12]* %4, [4 x i12]* %6, [4 x i12]* %8, [4 x i12]* %10, i64 %2)
  ret void
}

...
architecture behave of kernel_control_s_axi is
    ...
    constant ADDR_A_0_DATA_0 : INTEGER := 16#10#;
    constant ADDR_A_0_DATA_1 : INTEGER := 16#14#;
    constant ADDR_A_0_CTRL   : INTEGER := 16#18#;
    constant ADDR_A_1_DATA_0 : INTEGER := 16#1c#;
    constant ADDR_A_1_DATA_1 : INTEGER := 16#20#;
    constant ADDR_A_1_CTRL   : INTEGER := 16#24#;
    constant ADDR_A_2_DATA_0 : INTEGER := 16#28#;
    constant ADDR_A_2_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_A_2_CTRL   : INTEGER := 16#30#;
    constant ADDR_A_3_DATA_0 : INTEGER := 16#34#;
    constant ADDR_A_3_DATA_1 : INTEGER := 16#38#;
    constant ADDR_A_3_CTRL   : INTEGER := 16#3c#;
    constant ADDR_B_0_DATA_0 : INTEGER := 16#40#;
    constant ADDR_B_0_DATA_1 : INTEGER := 16#44#;
    constant ADDR_B_0_CTRL   : INTEGER := 16#48#;
    constant ADDR_B_1_DATA_0 : INTEGER := 16#4c#;
    constant ADDR_B_1_DATA_1 : INTEGER := 16#50#;
    constant ADDR_B_1_CTRL   : INTEGER := 16#54#;
    constant ADDR_B_2_DATA_0 : INTEGER := 16#58#;
    constant ADDR_B_2_DATA_1 : INTEGER := 16#5c#;
    constant ADDR_B_2_CTRL   : INTEGER := 16#60#;
    constant ADDR_B_3_DATA_0 : INTEGER := 16#64#;
    constant ADDR_B_3_DATA_1 : INTEGER := 16#68#;
    constant ADDR_B_3_CTRL   : INTEGER := 16#6c#;
    constant ADDR_C_0_DATA_0 : INTEGER := 16#70#;
    constant ADDR_C_0_DATA_1 : INTEGER := 16#74#;
    constant ADDR_C_0_CTRL   : INTEGER := 16#78#;
    constant ADDR_C_1_DATA_0 : INTEGER := 16#7c#;
    constant ADDR_C_1_DATA_1 : INTEGER := 16#80#;
    constant ADDR_C_1_CTRL   : INTEGER := 16#84#;
    constant ADDR_C_2_DATA_0 : INTEGER := 16#88#;
    constant ADDR_C_2_DATA_1 : INTEGER := 16#8c#;
    constant ADDR_C_2_CTRL   : INTEGER := 16#90#;
    constant ADDR_C_3_DATA_0 : INTEGER := 16#94#;
    constant ADDR_C_3_DATA_1 : INTEGER := 16#98#;
    constant ADDR_C_3_CTRL   : INTEGER := 16#9c#;

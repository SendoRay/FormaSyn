...
using hls::sim::Byte;
extern "C" void kernel(Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<2>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int);
extern "C" void apatb_kernel_hw(volatile void * __xlx_apatb_param_a_0, volatile void * __xlx_apatb_param_a_1, volatile void * __xlx_apatb_param_a_2, volatile void * __xlx_apatb_param_a_3, volatile void * __xlx_apatb_param_a_4, volatile void * __xlx_apatb_param_a_5, volatile void * __xlx_apatb_param_a_6, volatile void * __xlx_apatb_param_a_7, volatile void * __xlx_apatb_param_b_0, volatile void * __xlx_apatb_param_b_1, volatile void * __xlx_apatb_param_b_2, volatile void * __xlx_apatb_param_b_3, volatile void * __xlx_apatb_param_b_4, volatile void * __xlx_apatb_param_b_5, volatile void * __xlx_apatb_param_b_6, volatile void * __xlx_apatb_param_b_7, volatile void * __xlx_apatb_param_c_0, volatile void * __xlx_apatb_param_c_1, volatile void * __xlx_apatb_param_c_2, volatile void * __xlx_apatb_param_c_3, volatile void * __xlx_apatb_param_c_4, volatile void * __xlx_apatb_param_c_5, volatile void * __xlx_apatb_param_c_6, volatile void * __xlx_apatb_param_c_7) {
using hls::sim::createStream;
  // Collect __xlx_a_0__tmp_vec
std::vector<Byte<2>> __xlx_a_0__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_a_0__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_a_0)[i]);
}
  int __xlx_size_param_a_0 = 1;
  int __xlx_offset_param_a_0 = 0;
  int __xlx_offset_byte_param_a_0 = 0*2;
  // Collect __xlx_a_1__tmp_vec
std::vector<Byte<2>> __xlx_a_1__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_a_1__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_a_1)[i]);
}
  int __xlx_size_param_a_1 = 1;
  int __xlx_offset_param_a_1 = 0;
  int __xlx_offset_byte_param_a_1 = 0*2;
  // Collect __xlx_a_2__tmp_vec
std::vector<Byte<2>> __xlx_a_2__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_a_2__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_a_2)[i]);
}
  int __xlx_size_param_a_2 = 1;
  int __xlx_offset_param_a_2 = 0;
  int __xlx_offset_byte_param_a_2 = 0*2;
  // Collect __xlx_a_3__tmp_vec
std::vector<Byte<2>> __xlx_a_3__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_a_3__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_a_3)[i]);
}
  int __xlx_size_param_a_3 = 1;
  int __xlx_offset_param_a_3 = 0;
  int __xlx_offset_byte_param_a_3 = 0*2;
  // Collect __xlx_a_4__tmp_vec
std::vector<Byte<2>> __xlx_a_4__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_a_4__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_a_4)[i]);
}
  int __xlx_size_param_a_4 = 1;
  int __xlx_offset_param_a_4 = 0;
  int __xlx_offset_byte_param_a_4 = 0*2;
  // Collect __xlx_a_5__tmp_vec
std::vector<Byte<2>> __xlx_a_5__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_a_5__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_a_5)[i]);
}
  int __xlx_size_param_a_5 = 1;
  int __xlx_offset_param_a_5 = 0;
  int __xlx_offset_byte_param_a_5 = 0*2;
  // Collect __xlx_a_6__tmp_vec
std::vector<Byte<2>> __xlx_a_6__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_a_6__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_a_6)[i]);
}
  int __xlx_size_param_a_6 = 1;
  int __xlx_offset_param_a_6 = 0;
  int __xlx_offset_byte_param_a_6 = 0*2;
  // Collect __xlx_a_7__tmp_vec
std::vector<Byte<2>> __xlx_a_7__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_a_7__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_a_7)[i]);
}
  int __xlx_size_param_a_7 = 1;
  int __xlx_offset_param_a_7 = 0;
  int __xlx_offset_byte_param_a_7 = 0*2;
  // Collect __xlx_b_0__tmp_vec
std::vector<Byte<2>> __xlx_b_0__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_b_0__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_b_0)[i]);
}
  int __xlx_size_param_b_0 = 1;
  int __xlx_offset_param_b_0 = 0;
  int __xlx_offset_byte_param_b_0 = 0*2;
  // Collect __xlx_b_1__tmp_vec
std::vector<Byte<2>> __xlx_b_1__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_b_1__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_b_1)[i]);
}
  int __xlx_size_param_b_1 = 1;
  int __xlx_offset_param_b_1 = 0;
  int __xlx_offset_byte_param_b_1 = 0*2;
  // Collect __xlx_b_2__tmp_vec
std::vector<Byte<2>> __xlx_b_2__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_b_2__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_b_2)[i]);
}
  int __xlx_size_param_b_2 = 1;
  int __xlx_offset_param_b_2 = 0;
  int __xlx_offset_byte_param_b_2 = 0*2;
  // Collect __xlx_b_3__tmp_vec
std::vector<Byte<2>> __xlx_b_3__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_b_3__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_b_3)[i]);
}
  int __xlx_size_param_b_3 = 1;
  int __xlx_offset_param_b_3 = 0;
  int __xlx_offset_byte_param_b_3 = 0*2;
  // Collect __xlx_b_4__tmp_vec
std::vector<Byte<2>> __xlx_b_4__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_b_4__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_b_4)[i]);
}
  int __xlx_size_param_b_4 = 1;
  int __xlx_offset_param_b_4 = 0;
  int __xlx_offset_byte_param_b_4 = 0*2;
  // Collect __xlx_b_5__tmp_vec
std::vector<Byte<2>> __xlx_b_5__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_b_5__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_b_5)[i]);
}
  int __xlx_size_param_b_5 = 1;
  int __xlx_offset_param_b_5 = 0;
  int __xlx_offset_byte_param_b_5 = 0*2;
  // Collect __xlx_b_6__tmp_vec
std::vector<Byte<2>> __xlx_b_6__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_b_6__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_b_6)[i]);
}
  int __xlx_size_param_b_6 = 1;
  int __xlx_offset_param_b_6 = 0;
  int __xlx_offset_byte_param_b_6 = 0*2;
  // Collect __xlx_b_7__tmp_vec
std::vector<Byte<2>> __xlx_b_7__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_b_7__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_b_7)[i]);
}
  int __xlx_size_param_b_7 = 1;
  int __xlx_offset_param_b_7 = 0;
  int __xlx_offset_byte_param_b_7 = 0*2;
...
__xlx_c_7__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_c_7)[i]);
  ...
  int __xlx_size_param_c_7 = 1;
  int __xlx_offset_param_c_7 = 0;
  int __xlx_offset_byte_param_c_7 = 0*4;
  // DUT call
  kernel(__xlx_a_0__tmp_vec.data(), __xlx_a_1__tmp_vec.data(), __xlx_a_2__tmp_vec.data(), __xlx_a_3__tmp_vec.data(), __xlx_a_4__tmp_vec.data(), __xlx_a_5__tmp_vec.data(), __xlx_a_6__tmp_vec.data(), __xlx_a_7__tmp_vec.data(), __xlx_b_0__tmp_vec.data(), __xlx_b_1__tmp_vec.data(), __xlx_b_2__tmp_vec.data(), __xlx_b_3__tmp_vec.data(), __xlx_b_4__tmp_vec.data(), __xlx_b_5__tmp_vec.data(), __xlx_b_6__tmp_vec.data(), __xlx_b_7__tmp_vec.data(), __xlx_c_0__tmp_vec.data(), __xlx_c_1__tmp_vec.data(), __xlx_c_2__tmp_vec.data(), __xlx_c_3__tmp_vec.data(), __xlx_c_4__tmp_vec.data(), __xlx_c_5__tmp_vec.data(), __xlx_c_6__tmp_vec.data(), __xlx_c_7__tmp_vec.data(), __xlx_offset_byte_param_a_0, __xlx_offset_byte_param_a_1, __xlx_offset_byte_param_a_2, __xlx_offset_byte_param_a_3, __xlx_offset_byte_param_a_4, __xlx_offset_byte_param_a_5, __xlx_offset_byte_param_a_6, __xlx_offset_byte_param_a_7, __xlx_offset_byte_param_b_0, __xlx_offset_byte_param_b_1, __xlx_offset_byte_param_b_2, __xlx_offset_byte_param_b_3, __xlx_offset_byte_param_b_4, __xlx_offset_byte_param_b_5, __xlx_offset_byte_param_b_6, __xlx_offset_byte_param_b_7, __xlx_offset_byte_param_c_0, __xlx_offset_byte_param_c_1, __xlx_offset_byte_param_c_2, __xlx_offset_byte_param_c_3, __xlx_offset_byte_param_c_4, __xlx_offset_byte_param_c_5, __xlx_offset_byte_param_c_6, __xlx_offset_byte_param_c_7);
// print __xlx_apatb_param_a_0
for (size_t i = 0; i < __xlx_size_param_a_0; ++i) {
((Byte<2>*)__xlx_apatb_param_a_0)[i] = __xlx_a_0__tmp_vec[__xlx_offset_param_a_0+i];
}
// print __xlx_apatb_param_a_1
for (size_t i = 0; i < __xlx_size_param_a_1; ++i) {
((Byte<2>*)__xlx_apatb_param_a_1)[i] = __xlx_a_1__tmp_vec[__xlx_offset_param_a_1+i];
}
// print __xlx_apatb_param_a_2
for (size_t i = 0; i < __xlx_size_param_a_2; ++i) {
((Byte<2>*)__xlx_apatb_param_a_2)[i] = __xlx_a_2__tmp_vec[__xlx_offset_param_a_2+i];
}
// print __xlx_apatb_param_a_3
for (size_t i = 0; i < __xlx_size_param_a_3; ++i) {
((Byte<2>*)__xlx_apatb_param_a_3)[i] = __xlx_a_3__tmp_vec[__xlx_offset_param_a_3+i];
}
// print __xlx_apatb_param_a_4
for (size_t i = 0; i < __xlx_size_param_a_4; ++i) {
((Byte<2>*)__xlx_apatb_param_a_4)[i] = __xlx_a_4__tmp_vec[__xlx_offset_param_a_4+i];
}
// print __xlx_apatb_param_a_5
for (size_t i = 0; i < __xlx_size_param_a_5; ++i) {
((Byte<2>*)__xlx_apatb_param_a_5)[i] = __xlx_a_5__tmp_vec[__xlx_offset_param_a_5+i];
}
// print __xlx_apatb_param_a_6
for (size_t i = 0; i < __xlx_size_param_a_6; ++i) {
((Byte<2>*)__xlx_apatb_param_a_6)[i] = __xlx_a_6__tmp_vec[__xlx_offset_param_a_6+i];
}
// print __xlx_apatb_param_a_7
for (size_t i = 0; i < __xlx_size_param_a_7; ++i) {
((Byte<2>*)__xlx_apatb_param_a_7)[i] = __xlx_a_7__tmp_vec[__xlx_offset_param_a_7+i];
}
// print __xlx_apatb_param_b_0
for (size_t i = 0; i < __xlx_size_param_b_0; ++i) {
((Byte<2>*)__xlx_apatb_param_b_0)[i] = __xlx_b_0__tmp_vec[__xlx_offset_param_b_0+i];
}
// print __xlx_apatb_param_b_1
for (size_t i = 0; i < __xlx_size_param_b_1; ++i) {
((Byte<2>*)__xlx_apatb_param_b_1)[i] = __xlx_b_1__tmp_vec[__xlx_offset_param_b_1+i];
}
// print __xlx_apatb_param_b_2
for (size_t i = 0; i < __xlx_size_param_b_2; ++i) {
((Byte<2>*)__xlx_apatb_param_b_2)[i] = __xlx_b_2__tmp_vec[__xlx_offset_param_b_2+i];
}
// print __xlx_apatb_param_b_3
for (size_t i = 0; i < __xlx_size_param_b_3; ++i) {
((Byte<2>*)__xlx_apatb_param_b_3)[i] = __xlx_b_3__tmp_vec[__xlx_offset_param_b_3+i];
}
// print __xlx_apatb_param_b_4
for (size_t i = 0; i < __xlx_size_param_b_4; ++i) {
((Byte<2>*)__xlx_apatb_param_b_4)[i] = __xlx_b_4__tmp_vec[__xlx_offset_param_b_4+i];
}
// print __xlx_apatb_param_b_5
for (size_t i = 0; i < __xlx_size_param_b_5; ++i) {
((Byte<2>*)__xlx_apatb_param_b_5)[i] = __xlx_b_5__tmp_vec[__xlx_offset_param_b_5+i];
}
// print __xlx_apatb_param_b_6
for (size_t i = 0; i < __xlx_size_param_b_6; ++i) {
((Byte<2>*)__xlx_apatb_param_b_6)[i] = __xlx_b_6__tmp_vec[__xlx_offset_param_b_6+i];
}
// print __xlx_apatb_param_b_7
for (size_t i = 0; i < __xlx_size_param_b_7; ++i) {
((Byte<2>*)__xlx_apatb_param_b_7)[i] = __xlx_b_7__tmp_vec[__xlx_offset_param_b_7+i];
}

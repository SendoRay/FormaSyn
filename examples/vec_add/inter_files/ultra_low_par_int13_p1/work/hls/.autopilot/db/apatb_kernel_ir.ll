; ModuleID = '/home/chengzhy/FormaSyn/examples/vec_add/inter_files/ultra_low_par_int13_p1/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a16struct.ap_int<13>"([16 x i13]* noalias nocapture align 512 "unpacked"="0.0" %dst, [16 x %"struct.ap_int<13>"]* noalias readonly "unpacked"="1" %src) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_int<13>"([16 x i13]* nocapture "unpacked"="0.0" %dst, [16 x %"struct.ap_int<13>"]* readonly "unpacked"="1" %src, i64 "unpacked"="2" %num) local_unnamed_addr #2 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<13>"]* %src, null
  br i1 %0, label %ret, label %copy
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a16struct.ap_int<13>.5"([16 x %"struct.ap_int<13>"]* noalias "unpacked"="0" %dst, [16 x i13]* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_int<13>.8"([16 x %"struct.ap_int<13>"]* "unpacked"="0" %dst, [16 x i13]* nocapture readonly "unpacked"="1.0" %src, i64 "unpacked"="2" %num) local_unnamed_addr #2 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<13>"]* %dst, null
  br i1 %0, label %ret, label %copy

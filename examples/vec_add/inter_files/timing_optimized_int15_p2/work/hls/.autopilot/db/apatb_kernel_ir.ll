; ModuleID = '/home/chengzhy/FormaSyn/examples/vec_add/inter_files/timing_optimized_int15_p2/work/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %c_copy_0 = alloca [8 x i15], align 512
  %c_copy_1 = alloca [8 x i15], align 512
  %_06 = getelementptr [8 x i15], [8 x i15]* %c_copy_0, i64 0, i64 0
  %_17 = getelementptr [8 x i15], [8 x i15]* %c_copy_1, i64 0, i64 0
  call void @copy_in([16 x %"struct.ap_int<8>"]* nonnull %0, [8 x i8]* nonnull align 512 %a_copy_0, [8 x i8]* nonnull align 512 %a_copy_1, [16 x %"struct.ap_int<8>"]* nonnull %1, [8 x i8]* nonnull align 512 %b_copy_0, [8 x i8]* nonnull align 512 %b_copy_1, [16 x %"struct.ap_int<15>"]* nonnull %2, [8 x i15]* nonnull align 512 %c_copy_0, [8 x i15]* nonnull align 512 %c_copy_1)
  ...
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_06, i32 999, i32 1, i32 1, i1 false) ], !dbg !169
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_17, i32 999, i32 1, i32 1, i1 false) ], !dbg !169
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_06, i32 998, i32 1, i32 0, i1 false) ], !dbg !169
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i15* %_17, i32 998, i32 1, i32 0, i1 false) ], !dbg !169
  call void @apatb_kernel_hw([8 x i8]* %a_copy_0, [8 x i8]* %a_copy_1, [8 x i8]* %b_copy_0, [8 x i8]* %b_copy_1, [8 x i15]* %c_copy_0, [8 x i15]* %c_copy_1)
  call void @copy_back([16 x %"struct.ap_int<8>"]* %0, [8 x i8]* %a_copy_0, [8 x i8]* %a_copy_1, [16 x %"struct.ap_int<8>"]* %1, [8 x i8]* %b_copy_0, [8 x i8]* %b_copy_1, [16 x %"struct.ap_int<15>"]* %2, [8 x i15]* %c_copy_0, [8 x i15]* %c_copy_1)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_int<15>"([8 x i15]* nocapture "orig.arg.no"="0" "unpacked"="0.0.0" %dst_0, [8 x i15]* nocapture "orig.arg.no"="0" "unpacked"="0.0.1" %dst_1, [16 x %"struct.ap_int<15>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
...
for.loop:                                         ; preds = %dst.addr.0.0.06.exit, %for.loop.lr.ph
  ...
  %dst.addr.0.0.06_0 = getelementptr [8 x i15], [8 x i15]* %dst_0, i64 0, i64 %1
  %dst.addr.0.0.06_1 = getelementptr [8 x i15], [8 x i15]* %dst_1, i64 0, i64 %1
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a16struct.ap_int<15>"([8 x i15]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.0" %dst_0, [8 x i15]* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0.1" %dst_1, [16 x %"struct.ap_int<15>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #4 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<15>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16struct.ap_int<15>"([8 x i15]* %dst_0, [8 x i15]* %dst_1, [16 x %"struct.ap_int<15>"]* nonnull %src, i64 16)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_in([16 x %"struct.ap_int<8>"]* noalias readonly "orig.arg.no"="0" "unpacked"="0", [8 x i8]* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %_0, [8 x i8]* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %_1, [16 x %"struct.ap_int<8>"]* noalias readonly "orig.arg.no"="2" "unpacked"="2", [8 x i8]* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_01, [8 x i8]* noalias nocapture align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_12, [16 x %"struct.ap_int<15>"]* noalias readonly "orig.arg.no"="4" "unpacked"="4", [8 x i15]* noalias nocapture align 512 "orig.arg.no"="5" "unpacked"="5.0.0" %_03, [8 x i15]* noalias nocapture align 512 "orig.arg.no"="5" "unpacked"="5.0.1" %_14) #5 {
entry:
  ...
  call void @"onebyonecpy_hls.p0a16struct.ap_int<15>"([8 x i15]* align 512 %_03, [8 x i15]* align 512 %_14, [16 x %"struct.ap_int<15>"]* %2)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a16struct.ap_int<15>.8"([16 x %"struct.ap_int<15>"]* "orig.arg.no"="0" "unpacked"="0" %dst, [8 x i15]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, [8 x i15]* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.1" %src_1, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
...
for.loop:                                         ; preds = %src.addr.0.0.05.exit, %for.loop.lr.ph
  ...
  %1 = udiv i64 %for.loop.idx2, 2
  %2 = urem i64 %for.loop.idx2, 2
  %src.addr.0.0.05_0 = getelementptr [8 x i15], [8 x i15]* %src_0, i64 0, i64 %1
  %src.addr.0.0.05_1 = getelementptr [8 x i15], [8 x i15]* %src_1, i64 0, i64 %1
...
src.addr.0.0.05.case.1:                           ; preds = %for.loop
  %6 = icmp eq i64 %2, 1
  call void @llvm.assume(i1 %6)
  %7 = bitcast i15* %src.addr.0.0.05_1 to i16*
  %8 = load i16, i16* %7
  %9 = trunc i16 %8 to i15
  br label %src.addr.0.0.05.exit

src.addr.0.0.05.exit:                             ; preds = %src.addr.0.0.05.case.1, %src.addr.0.0.05.case.0
  %10 = phi i15 [ %5, %src.addr.0.0.05.case.0 ], [ %9, %src.addr.0.0.05.case.1 ]
  store i15 %10, i15* %dst.addr.0.0.06, align 2
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a16struct.ap_int<15>.5"([16 x %"struct.ap_int<15>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, [8 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, [8 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %src_1) #4 {
entry:
  %0 = icmp eq [16 x %"struct.ap_int<15>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a16struct.ap_int<15>.8"([16 x %"struct.ap_int<15>"]* nonnull %dst, [8 x i15]* %src_0, [8 x i15]* %src_1, i64 16)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_out([16 x %"struct.ap_int<8>"]* noalias "orig.arg.no"="0" "unpacked"="0", [8 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %_0, [8 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %_1, [16 x %"struct.ap_int<8>"]* noalias "orig.arg.no"="2" "unpacked"="2", [8 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.0" %_01, [8 x i8]* noalias nocapture readonly align 512 "orig.arg.no"="3" "unpacked"="3.0.1" %_12, [16 x %"struct.ap_int<15>"]* noalias "orig.arg.no"="4" "unpacked"="4", [8 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="5" "unpacked"="5.0.0" %_03, [8 x i15]* noalias nocapture readonly align 512 "orig.arg.no"="5" "unpacked"="5.0.1" %_14) #6 {
entry:
  ...
  call void @"onebyonecpy_hls.p0a16struct.ap_int<15>.5"([16 x %"struct.ap_int<15>"]* %2, [8 x i15]* align 512 %_03, [8 x i15]* align 512 %_14)
  ret void
}
...
declare void @apatb_kernel_hw([8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i15]*, [8 x i15]*)
...
define void @kernel_hw_stub_wrapper([8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i8]*, [8 x i15]*, [8 x i15]*) #7 {
entry:
  ...
  %11 = bitcast i8* %10 to [16 x %"struct.ap_int<15>"]*
  call void @copy_out([16 x %"struct.ap_int<8>"]* %7, [8 x i8]* %0, [8 x i8]* %1, [16 x %"struct.ap_int<8>"]* %9, [8 x i8]* %2, [8 x i8]* %3, [16 x %"struct.ap_int<15>"]* %11, [8 x i15]* %4, [8 x i15]* %5)
  %12 = bitcast [16 x %"struct.ap_int<8>"]* %7 to %"struct.ap_int<8>"*
  %13 = bitcast [16 x %"struct.ap_int<8>"]* %9 to %"struct.ap_int<8>"*
  %14 = bitcast [16 x %"struct.ap_int<15>"]* %11 to %"struct.ap_int<15>"*
  call void @kernel_hw_stub(%"struct.ap_int<8>"* %12, %"struct.ap_int<8>"* %13, %"struct.ap_int<15>"* %14)
  call void @copy_in([16 x %"struct.ap_int<8>"]* %7, [8 x i8]* %0, [8 x i8]* %1, [16 x %"struct.ap_int<8>"]* %9, [8 x i8]* %2, [8 x i8]* %3, [16 x %"struct.ap_int<15>"]* %11, [8 x i15]* %4, [8 x i15]* %5)
  call void @free(i8* %6)
  call void @free(i8* %8)
...
!19 = !{!20, !8, !22}
!20 = !{!21}
!21 = !{!"2.0", [16 x i15]* null}
!22 = !{!23, !24}
!23 = !{!"2.0.0", [8 x i15]* null}
!24 = !{!"2.0.1", [8 x i15]* null}
!25 = !DILocation(line: 14, column: 9, scope: !26)
!26 = distinct !DISubprogram(name: "kernel", linkageName: "_Z6kernelP6ap_intILi8EES1_PS_ILi15EE", scope: !27, file: !27, line: 5, type: !28, isLocal: false, isDefinition: true, scopeLine: 5, flags: DIFlagPrototyped, isOptimized: false, unit: !138, variables: !4)
!27 = !DIFile(filename: "kernel.cpp", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/timing_optimized_int15_p2")
...
!32 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/ap_int.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/timing_optimized_int15_p2")
!33 = !{!34, !69, !74, !78, !83}
...
!36 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/etc/ap_int_base.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/timing_optimized_int15_p2")
!37 = !{!38, !56, !58, !60}
...
!40 = !DIFile(filename: "/tools/Xilinx/2025.1/Vitis/common/technology/autopilot/etc/ap_common.h", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/timing_optimized_int15_p2")
!41 = !{!42, !44, !48}
...
!91 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int<15>", file: !32, line: 18, size: 16, flags: DIFlagTypePassByValue, elements: !92, templateParams: !137, identifier: "_ZTS6ap_intILi15EE")
!92 = !{!93, !121, !125, !128, !131}
!93 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !91, baseType: !94)
!94 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ap_int_base<15, true>", file: !36, line: 124, size: 16, flags: DIFlagTypePassByValue, elements: !95, templateParams: !119, identifier: "_ZTS11ap_int_baseILi15ELb1EE")
!95 = !{!96, !110, !111, !112}
!96 = !DIDerivedType(tag: DW_TAG_inheritance, scope: !94, baseType: !97)
!97 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ssdm_int<15, true>", file: !40, line: 530, size: 16, flags: DIFlagTypePassByValue, elements: !98, templateParams: !108, identifier: "_ZTS8ssdm_intILi15ELb1EE")
!98 = !{!99, !101, !105}
!99 = !DIDerivedType(tag: DW_TAG_member, name: "V", scope: !97, file: !40, line: 532, baseType: !100, size: 15, align: 16)
!100 = !DIBasicType(name: "int15", size: 15, encoding: DW_ATE_signed)
...
!107 = !{null, !104, !100}
!108 = !{!109, !54}
!109 = !DITemplateValueParameter(name: "_AP_N", type: !53, value: i32 15)
!110 = !DIDerivedType(tag: DW_TAG_member, name: "width", scope: !94, file: !36, line: 148, baseType: !57, flags: DIFlagStaticMember, extraData: i32 15)
...
!112 = !DISubprogram(name: "operator=", linkageName: "_ZN11ap_int_baseILi15ELb1EEaSERKS0_", scope: !94, file: !36, line: 479, type: !113, isLocal: false, isDefinition: false, scopeLine: 479, flags: DIFlagPrototyped, isOptimized: false)
...
!119 = !{!120, !54}
!120 = !DITemplateValueParameter(name: "_AP_W", type: !53, value: i32 15)
...
!130 = !{null, !124, !81}
!131 = !DISubprogram(name: "operator=", linkageName: "_ZN6ap_intILi15EEaSERKS0_", scope: !91, file: !32, line: 154, type: !132, isLocal: false, isDefinition: false, scopeLine: 154, flags: DIFlagPrototyped, isOptimized: false)
...
!139 = !DIFile(filename: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/timing_optimized_int15_p2/work/hls/.autopilot/db/kernel.pp.0.cpp", directory: "/home/chengzhy/FormaSyn/examples/vec_add/inter_files/timing_optimized_int15_p2")
!140 = !{!141}

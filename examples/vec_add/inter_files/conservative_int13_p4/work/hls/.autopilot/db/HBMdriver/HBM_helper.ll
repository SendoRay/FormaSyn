...
%"struct.ap_int<13>.5" = type { %"struct.ap_int_base<13, true>.4" }
%"struct.ap_int_base<13, true>.4" = type { %"struct.ssdm_int<13, true>.3" }
%"struct.ssdm_int<13, true>.3" = type { i13 }
...
define void @_kernel_Set_c([4 x i13]*, [4 x i13]*, [4 x i13]*, [4 x i13]*, [16 x %"struct.ap_int<13>.5"]*, i64) {
entry:
  %6 = icmp eq [16 x %"struct.ap_int<13>.5"]* %4, null
...
for.loop:                                         ; preds = %dst.addr.0.0.06.exit, %for.loop.lr.ph
  ...
  %src.addr.0.0.05 = getelementptr [16 x %"struct.ap_int<13>.5"], [16 x %"struct.ap_int<13>.5"]* %4, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
  %dst.addr.0.0.06_0 = getelementptr [4 x i13], [4 x i13]* %0, i64 0, i64 %7
  %dst.addr.0.0.06_1 = getelementptr [4 x i13], [4 x i13]* %1, i64 0, i64 %7
  %dst.addr.0.0.06_2 = getelementptr [4 x i13], [4 x i13]* %2, i64 0, i64 %7
  %dst.addr.0.0.06_3 = getelementptr [4 x i13], [4 x i13]* %3, i64 0, i64 %7
  %9 = bitcast i13* %src.addr.0.0.05 to i16*
  %10 = load i16, i16* %9
...
dst.addr.0.0.06.case.0:                           ; preds = %for.loop
  store i13 %11, i13* %dst.addr.0.0.06_0, align 2
  br label %dst.addr.0.0.06.exit

dst.addr.0.0.06.case.1:                           ; preds = %for.loop
  store i13 %11, i13* %dst.addr.0.0.06_1, align 2
  br label %dst.addr.0.0.06.exit

dst.addr.0.0.06.case.2:                           ; preds = %for.loop
  store i13 %11, i13* %dst.addr.0.0.06_2, align 2
  br label %dst.addr.0.0.06.exit

dst.addr.0.0.06.case.3:                           ; preds = %for.loop
  %12 = icmp eq i64 %8, 3
  call void @llvm.assume(i1 %12)
  store i13 %11, i13* %dst.addr.0.0.06_3, align 2
  br label %dst.addr.0.0.06.exit
...
define void @kernel_Set_c([4 x [4 x i13]*]*, [16 x %"struct.ap_int<13>.5"]*, i64) {
entry:
  %3 = getelementptr [4 x [4 x i13]*], [4 x [4 x i13]*]* %0, i64 0, i64 0
  %4 = load [4 x i13]*, [4 x i13]** %3
  %5 = getelementptr [4 x [4 x i13]*], [4 x [4 x i13]*]* %0, i64 0, i64 1
  %6 = load [4 x i13]*, [4 x i13]** %5
  %7 = getelementptr [4 x [4 x i13]*], [4 x [4 x i13]*]* %0, i64 0, i64 2
  %8 = load [4 x i13]*, [4 x i13]** %7
  %9 = getelementptr [4 x [4 x i13]*], [4 x [4 x i13]*]* %0, i64 0, i64 3
  %10 = load [4 x i13]*, [4 x i13]** %9
  call void @_kernel_Set_c([4 x i13]* %4, [4 x i13]* %6, [4 x i13]* %8, [4 x i13]* %10, [16 x %"struct.ap_int<13>.5"]* %1, i64 %2)
  ret void
}

define void @_kernel_Get_c([16 x %"struct.ap_int<13>.5"]*, [4 x i13]*, [4 x i13]*, [4 x i13]*, [4 x i13]*, i64) {
entry:
  %6 = icmp eq [16 x %"struct.ap_int<13>.5"]* %0, null
  br i1 %6, label %ret, label %copy
...
for.loop:                                         ; preds = %src.addr.0.0.05.exit, %for.loop.lr.ph
  ...
  %7 = udiv i64 %for.loop.idx2, 4
  %8 = urem i64 %for.loop.idx2, 4
  %src.addr.0.0.05_0 = getelementptr [4 x i13], [4 x i13]* %1, i64 0, i64 %7
  %src.addr.0.0.05_1 = getelementptr [4 x i13], [4 x i13]* %2, i64 0, i64 %7
  %src.addr.0.0.05_2 = getelementptr [4 x i13], [4 x i13]* %3, i64 0, i64 %7
  %src.addr.0.0.05_3 = getelementptr [4 x i13], [4 x i13]* %4, i64 0, i64 %7
  %dst.addr.0.0.06 = getelementptr [16 x %"struct.ap_int<13>.5"], [16 x %"struct.ap_int<13>.5"]* %0, i64 0, i64 %for.loop.idx2, i32 0, i32 0, i32 0
...
src.addr.0.0.05.case.0:                           ; preds = %for.loop
  %9 = bitcast i13* %src.addr.0.0.05_0 to i16*
  %10 = load i16, i16* %9
  %11 = trunc i16 %10 to i13
  br label %src.addr.0.0.05.exit

src.addr.0.0.05.case.1:                           ; preds = %for.loop
  %12 = bitcast i13* %src.addr.0.0.05_1 to i16*
  %13 = load i16, i16* %12
  %14 = trunc i16 %13 to i13
  br label %src.addr.0.0.05.exit

src.addr.0.0.05.case.2:                           ; preds = %for.loop
  %15 = bitcast i13* %src.addr.0.0.05_2 to i16*
  %16 = load i16, i16* %15
...
src.addr.0.0.05.case.3:                           ; preds = %for.loop
  ...
  %19 = bitcast i13* %src.addr.0.0.05_3 to i16*
  %20 = load i16, i16* %19
...
src.addr.0.0.05.exit:                             ; preds = %src.addr.0.0.05.case.3, %src.addr.0.0.05.case.2, %src.addr.0.0.05.case.1, %src.addr.0.0.05.case.0
  %22 = phi i13 [ %11, %src.addr.0.0.05.case.0 ], [ %14, %src.addr.0.0.05.case.1 ], [ %17, %src.addr.0.0.05.case.2 ], [ %21, %src.addr.0.0.05.case.3 ]
  store i13 %22, i13* %dst.addr.0.0.06, align 2
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %5
  br i1 %exitcond, label %for.loop, label %copy.split
...
define void @kernel_Get_c([16 x %"struct.ap_int<13>.5"]*, [4 x [4 x i13]*]*, i64) {
entry:
  %3 = getelementptr [4 x [4 x i13]*], [4 x [4 x i13]*]* %1, i64 0, i64 0
  %4 = load [4 x i13]*, [4 x i13]** %3
  %5 = getelementptr [4 x [4 x i13]*], [4 x [4 x i13]*]* %1, i64 0, i64 1
  %6 = load [4 x i13]*, [4 x i13]** %5
  %7 = getelementptr [4 x [4 x i13]*], [4 x [4 x i13]*]* %1, i64 0, i64 2
  %8 = load [4 x i13]*, [4 x i13]** %7
  %9 = getelementptr [4 x [4 x i13]*], [4 x [4 x i13]*]* %1, i64 0, i64 3
  %10 = load [4 x i13]*, [4 x i13]** %9
  call void @_kernel_Get_c([16 x %"struct.ap_int<13>.5"]* %0, [4 x i13]* %4, [4 x i13]* %6, [4 x i13]* %8, [4 x i13]* %10, i64 %2)
  ret void
}

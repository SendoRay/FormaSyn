...
void kernel(ap_int<8> x_in, ap_int<8>& y_out_scale) {
    ...
    #pragma HLS ARRAY_PARTITION variable=taps cyclic factor=8
    ...
    // Shift input into tap delay line
    for (int i = 15; i > 0; i--) {
    ...
    #pragma HLS ARRAY_PARTITION variable=products cyclic factor=8
    ...
    // Scale output by 0.75 (multiply by 3/4)
